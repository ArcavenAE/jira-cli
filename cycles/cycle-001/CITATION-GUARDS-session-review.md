...
|------|-------|-----------|--------|------------|--------------|
| Story A F3 | S-MUTANTS-SCOPE-GUARDS-1 | D-151 STRICT (VA lens streak-resetting) | 44 | 47 | 14 |
| Story A F4 | same | BC-5.39.001 per-story | 9 | 5 | 7/8/9 |
| Story B F3 | S-BC-CITATION-GUARD-1 | D-153 STANDARD (VA = LOW-INFO, non-resetting) | 15 | 9 | 13/14/15 |
...
|-------|-------------|----------|-------|
| Spec-internal contradiction (jointly-unsatisfiable constraints) | Story B F3 pass 2 | CRIT | D-154: §-form strip + CamelCase branch couldn't coexist under old grammar; grammar extension required mid-loop research adjudication |
...
**Lens effectiveness:** Coherence/ground-truth lenses caught spec-internal contradictions (D-154); fixture-mechanics lens caught implementation-breaking gaps (Fixture H); registration-surface lens caught count drift repeatedly. VA lens added value on Story A (p52 catch) but at high cost.
...
| Adversary factual-claim refutation (.snap existence) | Story B F4 p1 | Orchestrator ran `find src/cli/auth/tests/snapshots/` — 30-second empirical check refuted the claim; net-positive two-tier spec amendment | ORCHESTRATOR-EMPIRICAL-REFUTATION codified (D-156) |
...
| Registration-surface drift: 3 consecutive fix rounds for same class | Story B F3 p10-12 | 3 separate passes needed to close all surfaces | REGISTRATION-SURFACE-SWEEP codified (D-156): grep all carrier files on FIRST count-staleness find |
...
|-------|--------|----------|------------|
| Story A F3 D-151 strict | 44 | 58% | Dominant cost center; ~15 passes attributable to VA-lens meta-cycling beyond marginal-value cliff |
...
**Patterns vs prior cycles:** The SWEEP-WHOLE-TOUCHED-FILE lesson from D-149 (CITATION-DEBT-PRODUCT-FILES) recurred as REGISTRATION-SURFACE-SWEEP in Story B — same root cause, different surface. Three recurrences of the count-propagation class across the cycle (D-148, D-149, D-155) indicate this is a systemic pattern warranting the mechanical guard in Recommendation 3.

---

_Review complete. Evidence base: STATE.md (D-150..156), convergence-trajectory.md §Story A F3/F4 + §Story B F3/F4, lessons.md (ORCHESTRATOR-EMPIRICAL-REFUTATION + REGISTRATION-SURFACE-SWEEP), research/story-b-open-questions-2026-07-05.md, research/story-b-grammar-adjudication-2026-07-06.md._
