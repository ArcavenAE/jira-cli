...
- BC-3.8.012 REVERSED -- the D-188 `--field`-on-platform-create exit-64 guard is removed; the reversal is proposed as **D-307** (not yet formally registered).
...
**Decisions of record:** D-307 (reverses D-188) -- PROPOSED, needs formal registration at cycle close. ADR-0019 (Accepted 2026-08-25).
...
checkpoint's resume prompt was hoping to establish). D-307 was found to already be
allocated (see `cycles/cycle-002/burst-log.md` Burst 1, finding C-M1) and renumbered to
D-310 — the "Register D-307" process-gap item above is superseded by "Register D-310"
...
**Decisions of record:** D-310 (reverses D-188; proposed, propagation complete) -- still needs formal registration at cycle close. ADR-0019 (Accepted 2026-08-25; § Amendment 2026-08-26).

**Process-gap follow-ups owed at cycle close (as of round-2, carried forward to round-3):**
1. Register D-310 formally.
...
**Decisions of record:** D-310 (reverses D-188; proposed, propagation complete) -- still needs formal registration at cycle close. ADR-0019 (Accepted 2026-08-25; § Amendment 2026-08-26 D1/D2/D3 + F-B).
...
**Decisions of record:** D-310 (proposed, propagation complete) -- still needs formal registration. ADR-0019 (Accepted 2026-08-25; § Amendment D1/D2/D3 + F-B + D4).
...
**Decisions of record:** D-310 (proposed, propagation complete) -- still needs formal registration. ADR-0019 (Accepted 2026-08-25; § Amendment D1/D2/D3 + F-B + D4 + D2 correction, later itself corrected round-6).
...
**Decisions of record:** D-310 (reverses D-188; proposed, propagation complete) -- still needs formal registration. ADR-0019 (Accepted 2026-08-25; § Amendment D1/D2/D3 + F-B + D4 + D2 correction + D2 count fix).
...
**Decisions of record (as of this checkpoint, now superseded):** D-310 (reverses D-188; proposed, propagation complete) -- **still needs formal registration**, owed at the F2 human gate / cycle close. ADR-0019 (Accepted 2026-08-25; 6 amendment rounds through round-6's D2 count fix). D2-collision-guard-extension-to-JSM question (F-3, round-4) remains DEFERRED, owed at the F2 human gate.
...
1. Register D-310 formally. *(DONE at the F2 gate -- REGISTERED.)*
...
**Pending human decision (as of this checkpoint):** F2 human gate (Step 8) -- confirm convergence, register D-310, decide the DEC-namespace question, decide F-3 (D2-extension-to-JSM), and confirm/override the MINOR spec-version classification. *(Resolved -- see SUPERSEDING NOTE above.)*
...
**Position (as of this checkpoint):** Phase **F3** (incremental stories) -- not yet started. F2 (spec evolution) CLOSED, human-approved 2026-08-26 at the Step 8 gate; spec version APPLIED as v2.0.0 (MAJOR) under human delegation to the orchestrator (D-188->D-310 governance-flagged reversal).

**F1/F2 status (as of this checkpoint):** both COMPLETE + human-approved. F2: 12 new BCs (`§X.14` Field Option Discovery + BC-3.3.010/011 + BC-3.4.026-031), ADR-0019 (Accepted 2026-08-25, 6 amendment rounds), BC-3.8.012 reversed (D-310, REGISTERED). Mandatory adversarial spec-convergence loop CONVERGED (streak-6, 3/3 consecutive clean). Counts: 719 total BCs (BC-INDEX v6.82), 32 VPs, 106 holdout scenarios.

**This session's work (as of this checkpoint, 2026-08-26 F2 gate close + spec-version reconciliation):** human delivered 4 decisions at the F2 gate -- (1) gate APPROVED -> F3; (2) spec version initially deferred, then delegated to orchestrator, determined MAJOR (v2.0.0); (3) F-3 (JSM D2 collision-guard extension) RESOLVED -- retain last-wins, no extension; (4) D-310 REGISTERED. Full detail: `cycles/cycle-002/burst-log.md` Burst 8.
...
**F1/F2/F3 (as of this checkpoint):** COMPLETE + human-approved (unchanged). F2 closed 2026-08-26 at the Step 8 gate: 12 new BCs, ADR-0019, BC-3.8.012 reversed (D-310, REGISTERED), spec v2.0.0 MAJOR applied. F3 decomposed 5 stories, acyclic 3-wave plan. Counts: 719 total BCs (BC-INDEX v6.82), 32 VPs, 106 holdout scenarios -- unchanged by S-580-1's delivery.
