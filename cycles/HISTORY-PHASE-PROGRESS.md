...
> Extracted from `.factory/STATE.md`'s `## Phase Progress` table during the
> 2026-09-20 `RELEASE-v0.7.0-dev.8-2026-09-20` burst (v4.73 -> v4.74), to keep
> the live table at 12 rows after adding the new `RELEASE-v0.7.0-dev.8-2026-09-20`
> row. This was the oldest row at that point; archived here verbatim, unedited.
...
> Extracted from `.factory/STATE.md`'s `## Phase Progress` table during the
> 2026-09-21 `PR858-MERGE-DEPENDENCY-SWEEP-BOOKKEEPING-2026-09-21` burst
> (v4.76 -> v4.77), to keep the live table at 12 rows after adding the new
> `PR858-MERGE-DEPENDENCY-SWEEP-BOOKKEEPING-2026-09-21` row. This was the
> oldest row at that point; archived here verbatim, unedited.
...
> Extracted from `.factory/STATE.md`'s `## Phase Progress` table during the
> 2026-09-22 `CYCLE-009-F4-COMPLETE-2026-09-22` burst (v4.81 -> v4.82), to keep
> the live table at 12 rows after adding the new
> `CYCLE-009-F4-COMPLETE-2026-09-22` row. This was the oldest row at that
> point; archived here verbatim, unedited.
...
> Extracted from `.factory/STATE.md`'s `## Phase Progress` table during the
> 2026-09-22 `CYCLE-009-F6-HARDENED-2026-09-22` burst (v4.83 -> v4.84), to keep
> the live table at 12 rows after adding the new
> `CYCLE-009-F6-HARDENED-2026-09-22` row. This was the oldest row at that
> point; archived here verbatim, unedited.
