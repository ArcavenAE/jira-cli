...
project: jira-cli
mode: brownfield
current_step: "SOH-ATTACHMENTS-1 F2: adversary pass-1 (22 findings) fully remediated (spec v1.3.45; BC 657; holdouts 95; DEC-180 scope expansion); consistency r6-r8 settled (final: 1 INFO folded at close); adversary pass 2 DISPATCHED."
...
<!--
  ...
  Hard cap (500 lines) margin from soft-target = 500 - 356 = 144; margin from actual = 500 - 356 = 144 (D-446(c) dual-margin form). 356 lines (wc-l).
  Hard cap: 500 lines.
-->
...
| **Last Updated** | 2026-07-15: SOH-ATTACHMENTS-1 F2 adversary pass-1 REMEDIATED — 22 findings (4H/9M/8L/1I) fixed in 3 rounds; BC 657; holdouts 95; spec v1.3.45; DEC-180 scope expansion; consistency r6-r8 settled; pass 2 DISPATCHED. develop @ 56d5126. |
| **Current Phase** | Phase 3 — **SOH-ATTACHMENTS-1 F2 ADVERSARY PASS-1 REMEDIATED (2026-07-15)**. Spec v1.3.45. Stories **111**. develop @ 56d5126. BC **657**. Holdouts **95**. VP **30**. |
...
| **SOH-ATTACHMENTS-1 F2 ADVERSARY PASS-1 REMEDIATED (2026-07-15) — pass 1 NOT-CLEAN 22 findings (4H/9M/8L/1I); fix rounds A (20 corrections) + B (+6 BCs BC-3.9.015..020, +7 holdouts H-NEW-ATTACHMENT-001..007) + C (integrate 657/95, spec v1.3.45); consistency r6/r7/r8 (5→4→1i); guards green throughout. Gate: adversary pass 2 in flight.** | **ADVERSARY PASS-1 REMEDIATED** | **2026-07-15** | **Adversary pass 2 in flight.** | `phase-f2-spec-evolution/consistency-report-576-r6.md`; BC 657; holdouts 95; spec v1.3.45. |
...
| **SOH-ATTACHMENTS-1 F2 ADVERSARY PASS-1 REMEDIATED (2026-07-15): 22 findings (4H/9M/8L/1I); fix round A (20 corrections) + B (+6 BCs BC-3.9.015..020 + +7 holdouts H-NEW-ATTACHMENT-001..007 + DEC-180 scope expansion) + C (integrate BC 657, holdouts 95, spec v1.3.45); consistency r6 (5 items) → r7 (4 items) → r8 (1 INFO, folded at close); guards green throughout. Pass 2 DISPATCHED.** | adversary + state-manager | COMPLETE | `phase-f2-spec-evolution/consistency-report-576-r6.md .. r8.md`; BC 657; holdouts 95; spec v1.3.45. |
...
| CV-FALSE-POSITIVE-CLOSURE | process-gap | Consistency r6 claimed the r5 ADR-count/holdout items resolved when the holdout section was not actually updated; caught by r7. Validator closure claims need artifact-level re-verification discipline. | LOW | OPEN — engine-side validator prompt candidate |
...
Trajectory-tail: →4H+9M+8L+1I→0→0→p2-pending (SOH-ATTACHMENTS-1 F2 adversary: p1 22 findings → remediated; p2 dispatched).

SOH-ATTACHMENTS-1 F2 consistency: 7→6→2→3i→CONSISTENT (piecewise r1..r5; "i" = INFO-only; guards 651/8 surfaces green throughout).

SOH-ATTACHMENTS-1 F2 adversary: p1 →4H+9M+8L+1I→(fix A/B/C)→0 open; consistency r6→r7→r8: 5→4→1i settled; p2 pending.
...
| **Position** | SOH-ATTACHMENTS-1 F1 APPROVED (DEC-179). F2 spec evolution in flight — adversary pass-1 remediated; pass 2 in flight. develop @ 56d5126 (v0.6.0-dev.10). BC 657; Stories 111; Holdouts 95; VP 30. No feature worktrees yet. |
...
| **Pending human decisions** | Merge PR #625 (docs/577-ej-probe-closeout; CI 14/14 green; HELD); merge #591 (MERGE-READY); #574 — approve held Actions run + contributor rebase; #598/#599 eligible 2026-07-16; #612 eligible 2026-07-20; #624 eligible 2026-07-22. |
| **Resume command** | /vsdd-factory:next-step (or new issue intake / maintenance trigger). |

## RESUME PLAN (cold-start, self-contained)

<!-- State snapshot: SOH-ATTACHMENTS-1 F1 GATE APPROVED (DEC-179). F2 adversary pass-1 REMEDIATED (DEC-180); pass 2 DISPATCHED. develop @ 56d5126. BC 657; Stories 111. Holdouts 95. VP 30. No feature worktrees yet. Pending human PR actions: #625, #591, #574, #598/#599, #612, #624. RESUME INTENT: F2 adversary convergence continues; pending human PRs. -->
...
**Step 3 — IN PROGRESS: SOH-ATTACHMENTS-1 F1 GATE APPROVED (2026-07-15, DEC-179); F2 ADVERSARY PASS-1 REMEDIATED; PASS 2 DISPATCHED:**
...
>
> **NEXT STEP: F2 spec evolution continues.** Run `/vsdd-factory:next-step` to proceed.
