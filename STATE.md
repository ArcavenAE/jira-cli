...
project: jira-cli
mode: brownfield
current_step: "IDLE. BC-SUB-CLAUSE PASS COMPLETE (2026-06-27). 4 new BCs + 1 EC (603→605). DEC-138. develop @ 3d8f15b (PR #562 docstring residual). BC count 605. Awaiting direction."
...
| **Last Updated** | 2026-06-27: BC-sub-clause pass CONVERGED — 4 BCs + 1 EC (603→605); 6-pass diverse-lens F2 + external research validation; DEC-138. PR #562 docstring residual shipped (develop @ 3d8f15b). MISSING-BC-SUBCLAUSE-PATTERN RESOLVED. |
| **Current Phase** | Phase 3 — IDLE (BC-sub-clause pass complete; v0.6.0-dev.7 shipped). BC **605**. NFR 42. ADR 16. Stories 92. Holdouts 70. |
...
| **D4 HOLDOUT REFRESH — CONVERGED + CLOSED** | **CONVERGED + CLOSED** | **2026-06-26** | **3 adv passes; CRITICAL boundary off-by-one caught; +10 scenarios; 60→70; v1.2.0. DEC-134.** | develop c70d8a7 → 9657b1e. PR #560 merged. Holdouts 70. |
...
|------|-------|--------|--------|
| **F5/F3/F7 RIGOR BACKFILL COMPLETE** — Post-merge F5 adversarial review for PRs #560+#561: CLEAN (0 CRIT/HIGH/MED, 3 LOW). Deviation: 1 pass not canonical 3 (DEC-136). F3 story S-D4-TEST-HARDENING-BACKFILL-1 filed (10 ACs). TEST-ONLY-GATE-ELIGIBILITY MEDIUM drift item added. Stories 91→92. | state-manager | COMPLETE | develop unchanged @ 5ab4e0f. DEC-136. |
...
| E2E-EDGE-CASE-GAPS-2026-06-27 | E2E coverage | Gap inventory from 2-part static E2E edge-case audit (2026-06-27). **Offline CLI tier:** G-EDIT-FIELD-LABEL-GUARD, G-EDIT-FIELD-C1-BULK, extend #526 error-shape JSON to `issue changelog`/`queue view`/`requesttype list`. **Wiremock tier:** G-ADF-INV1-INLINE-HTML (BC-7.2.011 INV-1), G-H2 partial_match no-HTTP, G-MOVE-BULK-NONIDEMPOTENT (forced-400). **Holdout tier: G-ADF-FOOTNOTE UNBLOCKED 2026-06-27 (BC-7.2.013 anchor exists); G-ADF-BARE-URL UNBLOCKED 2026-06-27 (BC-7.2.014 anchor exists).** Infra edges ALREADY GREEN at wiremock tier — MUST NOT be re-created live. Reports: `.factory/research/e2e-edge-case-audit-2026-06-27-read.md`, `.factory/research/e2e-edge-case-audit-2026-06-27-write.md`. DEC-137. | MEDIUM | TRACKED DEFERRAL — holdout-tier items G-ADF-FOOTNOTE/G-ADF-BARE-URL UNBLOCKED |
...
- develop @ **3d8f15b** (LOCAL == origin/develop, PR #562 squash-merged 2026-06-27). Tag v0.6.0-dev.7 pushed on 342987f (activation_head). activation_head/version: 342987f / v0.6.0-dev.7.
...
- PRs #547..#562 ALL MERGED. **Open PRs: NONE.**
- Counters: BC **605**, NFR **42**, ADR **16**, Stories **92**. Holdouts **70**.

**Step 3 — IDLE. BC-SUB-CLAUSE PASS COMPLETE. MISSING-BC-SUBCLAUSE-PATTERN RESOLVED. Present open items to human, await direction.**
- **BC-SUBCLAUSE PASS (2026-06-27):** 4 BCs + 1 EC (603→605): BC-7.2.013 (footnote→ADF), BC-7.2.014 (bare-URL autolink), BC-7.3.010 (JSON render invariant), BC-6.2.018 (cache warm-hit no-HTTP), BC-X.10.001 EC-1 (partial_match no-network). 6-pass diverse-lens F2 + external research validation. MISSING-BC-SUBCLAUSE-PATTERN RESOLVED. DEC-138. Unblocked: P4/P5 cache wiremock + G-ADF-FOOTNOTE/G-ADF-BARE-URL holdout items.
- **PR #562 (MERGED @ 3d8f15b):** `docs(test): correct stale RED-gate docstring in adf_recursion_depth.rs` — comment-only; adversary CLEAN; 15/15 CI green.
- **E2E EDGE-CASE AUDIT (2026-06-27):** Static 2-part audit. Key insight: live E2E is happy-path-by-design; edge-case coverage belongs at wiremock/holdout tiers. E2E-EDGE-CASE-GAPS-2026-06-27 tracked (MEDIUM). DEC-137.
