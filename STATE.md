...
<!-- STATE.md SIZE BUDGET (2026-08-04 SESSION-WRAP-BURST-2): 300 lines (wc-l) — prior: 300; delta: 0. Soft-target 200; margin from soft-target = +100; margin from actual to hard cap 500 = 200. HOUSEKEEPING NOTE: 100 lines over soft-target — recommend /vsdd-factory:compact-state before next big burst. New: +1 CPS row (SESSION-WRAP); -1 CPS row (PRE-WINDOW-PREP archived); Session Resume Checkpoint replaced. -->
