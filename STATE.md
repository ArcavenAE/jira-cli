...
<!--
  ...
  Hard cap (500 lines) margin from soft-target = 500 - 341 = 159; margin from actual = 500 - 341 = 159 (D-446(c) dual-margin form). 341 lines (wc-l).
  Hard cap: 500 lines.
-->
...
| DEC-178 | **ALL-DEPENDABOT SOAK BROADENED (2026-07-15, human): ≥7-day soak extends to ALL dependabot PRs (cargo included), not just third-party Actions bumps — broadens DEC-133. Applied in 2026-07-15 triage: only #591 (9 days) cleared; #598/#599/#612/#624 HELD with eligibility dates (07-16, 07-16, 07-20, 07-22).** | Human triage established cargo dependabot PRs carry the same soak requirement as Actions bumps; DEC-133 was scoped too narrowly. | Steady-state burst / PR triage | 2026-07-15 |
