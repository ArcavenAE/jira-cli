...
F5 (scoped adversarial on the full 6-story delta) → F6 (targeted hardening: formal-verify/fuzz/mutation/security scoped to the Windows delta + full-tree regression) → F7 (5-dimension delta convergence + final human gate).
