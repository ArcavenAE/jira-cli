...
timestamp: 2026-09-09T19:57:56Z
phase: "cycle-005 (adf-mentions) Phase F4 -- Wave 1 (S-cycle5-mention-pure-conversion) MERGED (PR #778 @ 708c8b32, DEC-352, escape-hatch admin-bypass); standalone maintenance PR #793 (nightly mutation visibility) MERGED @ 5b00b31e; Wave 2 (S-cycle5-mention-resolution-wiring) DISPATCHED to per-story delivery 2026-09-09, worktree feat/cycle5-mention-resolution-wiring created from develop @ 5b00b31e, dependency satisfied. develop @ 5b00b31e."
pipeline: ACTIVE
inputs: []
...
project: jira-cli
mode: brownfield
last_amended: "2026-09-09, v3.95, state-manager -- F4-WAVE2-DISPATCH-2026-09-09: human-authorized resume of the SESSION-WRAP pause and dispatch of cycle-005 Phase F4 Wave 2 (S-cycle5-mention-resolution-wiring) to per-story delivery; pipeline set to ACTIVE; worktree feat/cycle5-mention-resolution-wiring confirmed created from develop @ 5b00b31e; no DEC minted -- a dispatch/status transition, not a phase-gate decision."
current_step: "D-chain cite D-053 latest brownfield. F4-WAVE2-DISPATCH-2026-09-09: state-manager recorded the human-authorized resume + dispatch of cycle-005 Phase F4 Wave 2 (S-cycle5-mention-resolution-wiring) to per-story delivery -- set pipeline: PAUSED -> ACTIVE, refreshed timestamp to the dispatch instant, flipped STORY-INDEX.md status draft -> in-progress on both the registry row (~L1235) and detail row (~L1652) (dependency S-cycle5-mention-pure-conversion SATISFIED/merged, F3-approved via DEC-347), updated sprint-state.yaml's cycle_005_adf_mentions wave_2_status and the S-cycle5-mention-resolution-wiring story entry to in-progress/dispatched reflecting the existing worktree feat/cycle5-mention-resolution-wiring (created from develop @ 5b00b31e), archived the v3.94 Session Resume Checkpoint to cycles/cycle-005/session-checkpoints.md BEFORE writing the new v3.95 checkpoint, appended a Phase Progress row F4-WAVE2-DISPATCH-2026-09-09, recomputed wc -l and refreshed the SIZE BUDGET banner, committed this burst plus the concurrently-modified sidecar-learning.md (verified legitimate) in one atomic commit to factory-artifacts, pushed to origin; no DEC minted (dispatch/status transition, not a phase-gate decision); trajectory-tail unchanged →1→3→0→2"
...
cycle_005_status: "adf-mentions -- OPEN, active cycle, pipeline ACTIVE (resumed 2026-09-09, Burst 8). Phase F1 delta analysis APPROVED (DEC-344); Phase F2 spec evolution APPROVED (DEC-345 tightening + DEC-346 approval); Phase F3 story decomposition APPROVED (DEC-347); Phase F4 (delta implementation) IN PROGRESS -- Wave 1 (S-cycle5-mention-pure-conversion) MERGED 2026-09-09 via the >120-mutant escape-hatch ADMIN-BYPASS, human-authorized (DEC-352): PR #778 squash-merged to develop @ 708c8b32 (develop a9168212->708c8b32); per-story adversarial convergence was COMPLETE (3 clean passes) pre-merge. A standalone maintenance/enhancement PR (#793, ci/mutation-nightly-visibility, NOT a cycle-005 story, no DEC minted) subsequently squash-merged to develop as 5b00b31e (708c8b32->5b00b31e), 2026-09-09T18:35Z: surfaces nightly mutation kill-rate via $GITHUB_STEP_SUMMARY + docs, closing cycle-006's S-7.02 deferral CYCLE6-LOW-STALE-CHECK-KILL-RATE-COMMENTS and operationalizing the badge-visibility research (option #1 landed; dynamic badge DEFERRED). Wave 2 (S-cycle5-mention-resolution-wiring, 13 pts, HIGH, depends_on:[S-cycle5-mention-pure-conversion]) dependency SATISFIED and, as of this burst, DISPATCHED to per-story delivery (worktree feat/cycle5-mention-resolution-wiring created from develop @ 5b00b31e; human-required live-Jira E2E round-trip H-NEW-MENTION-009 not yet started). The DEC-347 interim-shippability-window tradeoff (pure bracket-mention conversion merged without effectful preflight/resolution wiring) remains OPEN, target closure = Wave 2's BC-X.7.010 preflight landing. See phase-f1-delta-analysis/cycle-005/ + phase-f2-spec-evolution/{prd,verification,architecture}-delta-674.md + cycles/cycle-005/phase-f3-stories/ + .factory/sprint-state.yaml cycle_005_adf_mentions + cycles/cycle-005/burst-log.md Bursts 1-8."
cycle_006_status: "mutants-ci-sharding -- CLOSED (DEC-348/349/350/351), NO RELEASE (CI-infrastructure-only; shipped binary byte-identical; next release rides cycle-005). F1 APPROVED 2026-09-07 (DEC-348); F2 APPROVED at the gate 2026-09-07 (DEC-349, 16-pass adversarial convergence); F3 APPROVED at the gate 2026-09-08 (DEC-350, story convergence 32/33/34); F4 (delta implementation) COMPLETE + MERGED 2026-09-09 -- PR #791 squash-merged to develop @ a9168212 (Step-4.5 3-consecutive-clean via 7 trios/21 passes/6 fix rounds; pr-reviewer APPROVE; security-reviewer near-clean; all 24 CI checks passed incl. the sharded pipeline's first live production run); F5 (scoped adversarial refinement) and F6 (targeted hardening) completed with no separate human gate (feature-mode convention -- results folded into F7's evidence); F7 (delta convergence, Burst 13) reached a 5-dimensional PASS and was human-APPROVED at the gate (DEC-351), 2026-09-09, cycle CLOSED with NO release cut. S-7.02 cycle-closing checklist executed: 6 items recorded as justified deferrals at close (STALE-RED-NARRATIVE-PATTERN, EXAMINE-GLOBS-SHRINK-RESIDUAL, BARE-JQ-TOKENIZER-RESIDUAL, GITHUB-OPS-WATCH-HANG, F-PC-MED-001, CYCLE6-LOW-STALE-CHECK-KILL-RATE-COMMENTS); F-PE-MED-001 and R-F2 marked RESOLVED/CLOSED (not deferrals). CYCLE6-LOW-STALE-CHECK-KILL-RATE-COMMENTS was itself subsequently RESOLVED 2026-09-09 by the standalone PR #793 (@ 5b00b31e) -- see Drift/Standing Items. Full detail: phase-f1-delta-analysis/cycle-006/ + phase-f2-spec-evolution/cycle-006/ + cycles/cycle-006/phase-f3-stories/ + cycles/cycle-006/blocking-issues-resolved.md + cycles/cycle-006/session-checkpoints.md + cycles/cycle-006/burst-log.md Bursts 1-13 + Decisions Log DEC-348/349/350/351."
activation_head: "a9168212"
activation_version: "v0.7.0-dev.5"
---

<!-- STATE.md SIZE BUDGET (2026-09-09, cycle-005 Burst 8 -- F4 WAVE 2 DISPATCH;
     line count refreshed after this burst's Write):
     Human-authorized resume of the SESSION-WRAP pause (Burst 7): this burst dispatches
     cycle-005 Phase F4 Wave 2 (`S-cycle5-mention-resolution-wiring`) to per-story delivery.
     `pipeline:` PAUSED -> ACTIVE. `phase:` rewritten to drop the `PAUSED 2026-09-09.`
     prefix and record: cycle-005 (`adf-mentions`) Phase F4 -- Wave 1
     (`S-cycle5-mention-pure-conversion`) MERGED (PR #778 @ `708c8b32`, DEC-352,
     escape-hatch admin-bypass); standalone maintenance PR #793 (nightly mutation
     visibility) MERGED @ `5b00b31e`; Wave 2 (`S-cycle5-mention-resolution-wiring`)
     DISPATCHED to per-story delivery, worktree `feat/cycle5-mention-resolution-wiring`
     created from `develop` @ `5b00b31e`. `develop` @ `5b00b31e`.
     The v3.94 Session Resume Checkpoint was archived to `cycles/cycle-005/session-checkpoints.md`
     (the cycle-005 Burst 7 that produced it) ahead of this Write, with a "Superseded at"
     note; exactly one new v3.95 checkpoint was written recording the ACTIVE pipeline and
     dispatched Wave 2. A Burst 8 entry was appended to `cycles/cycle-005/burst-log.md`.
     `current_cycle`/`feature_mode_bundle` stay `cycle-005`/`adf-mentions` (unchanged).
     `version:` 3.94 -> 3.95 (exactly one bump).
     STORY-INDEX.md: `S-cycle5-mention-resolution-wiring` status draft -> in-progress on
     both the registry row (~L1235) and detail row (~L1652) -- dependency
     `S-cycle5-mention-pure-conversion` SATISFIED/merged, F3-approved via DEC-347. No new
     story authored -- counts unchanged (754 BCs / 76 VPs / 118 holdouts / 175 stories).
     `sprint-state.yaml`'s `cycle_005_adf_mentions` wave_2_status and the story entry
     updated to in-progress/dispatched, recording the worktree and dispatch date.
     `activation_head` (`a9168212`) and `activation_version` (`v0.7.0-dev.5`) are
     UNCHANGED -- no release tag was cut.
     `last_amended` is a full overwrite (BC-5.45.001 write-path discipline), not a
     concatenation of the prior entry.
     The concurrently-modified `sidecar-learning.md` (append-only session-end marker(s),
     dirty since earlier in the session) was verified as a legitimate factory learning
     artifact and included in this same atomic commit, so the factory-artifacts working
     tree ends CLEAN (PC-12). The concurrently-modified `regression-state.json` (a test-run
     scratch file overwritten by a concurrent per-story-delivery test run inside the
     `.worktrees/S-cycle5-mention-resolution-wiring` worktree) was likewise verified as a
     legitimate, in-scope artifact of this same dispatch and included in the same commit.
     soft target 200 lines; hard cap 500 lines. 391 lines (wc-l) (this file, this Write).
     margin from soft-target = 391 - 200 = 191 (OVER the soft target; documented, ongoing
     known deviation across cycles-002/003/004/005/006, not a blocker). margin from actual
     = 500 - 391 = 109 (headroom remains before the hard cap).
     RECOVERY CONTEXT: no crash this burst -- a human-directed resume of a prior
     SESSION-WRAP PAUSE, dispatching cycle-005 Phase F4 Wave 2 to per-story delivery.
     No DEC minted -- a dispatch/status transition, not a phase-gate decision.
...
| **Pipeline Status** | **ACTIVE** (resumed 2026-09-09, Burst 8) -- cycle-005 Phase F4 Wave 2 DISPATCHED to per-story delivery; see Session Resume Checkpoint below for detail |
| **trajectory-tail** | →1→3→0→2 (unchanged this burst) |
| **Last Updated** | trajectory-tail →1→3→0→2; unchanged this burst. Burst 8 (2026-09-09, cycle-005) -- human-authorized resume + dispatch: `pipeline:` PAUSED->ACTIVE; cycle-005 Phase F4 Wave 2 (`S-cycle5-mention-resolution-wiring`) DISPATCHED to per-story delivery, worktree `feat/cycle5-mention-resolution-wiring` created from `develop` @ `5b00b31e`. See Session Resume Checkpoint below for full detail. |
| **Current Phase** | cycle-005 (`adf-mentions`) Phase F4 (delta implementation) IN PROGRESS, pipeline ACTIVE -- Wave 1 **MERGED** (**DEC-352**, PR #778 @ `708c8b32`); standalone maintenance PR #793 also MERGED @ `5b00b31e`; Wave 2 (`S-cycle5-mention-resolution-wiring`) **DISPATCHED** 2026-09-09 to per-story delivery (worktree `feat/cycle5-mention-resolution-wiring` created from `develop` @ `5b00b31e`), dependency SATISFIED, F3-approved via DEC-347. cycle-006 (`mutants-ci-sharding`) remains **CLOSED**, historical (F1-F7 complete, DEC-348/349/350/351, NO release). cycle-001 through cycle-004 remain CLOSED, historical. |
| **Activation HEAD** | `a9168212` (unchanged this burst -- no release tag cut; `develop`'s real tip is `5b00b31e`) |
...
| **MAINTENANCE-PR-793-MERGED (standalone, Burst 6)** | **COMPLETE / MERGED** | 2026-09-09 | Normal merge (clean CI, pr-reviewer APPROVE, no escalation/admin-bypass needed) | PR #793 (`ci/mutation-nightly-visibility`) squash-merged to `develop` @ `5b00b31e` (`708c8b32`->`5b00b31e`). CI-visibility + docs enhancement: `mutants-nightly.yml` job-summary kill-rate table, `README.md`, `docs/specs/cargo-mutants-policy.md`, 2 stale-comment fixes. Closes cycle-006 S-7.02 deferral `CYCLE6-LOW-STALE-CHECK-KILL-RATE-COMMENTS`. Operationalizes badge-visibility research option #1 (job-summary+docs); dynamic shields badge DEFERRED. **NOT a cycle-005 story** -- standalone maintenance between Wave 1 and Wave 2. Full detail: `cycles/cycle-005/burst-log.md` Burst 6. | counts unchanged (754/76/118/175); no DEC minted (small merged enhancement) |
| **SESSION-WRAP-PAUSE-2026-09-09 (cycle-005, Burst 7)** | **COMPLETE** | 2026-09-09 | wrap skill Step 4 PAUSE checkpoint, state-manager bookkeeping only (no adversarial gate -- a session pause, not a phase/story gate) | `pipeline:` ACTIVE->PAUSED; `phase:`/`current_step:`/`last_amended:` refreshed via the verbatim-strict chain; v3.93 Session Resume Checkpoint archived to `cycles/cycle-005/session-checkpoints.md`, exactly one new v3.94 checkpoint written recording cycle-005 Phase F4 Wave 2 (`S-cycle5-mention-resolution-wiring`) READY/next NOT yet dispatched as the resume point. `develop` real tip unchanged at `5b00b31e`. | counts unchanged (754/76/118/175); no DEC minted |
| **F4-WAVE2-DISPATCH-2026-09-09 (cycle-005, Burst 8)** | **DISPATCHED** | 2026-09-09 | Human-authorized resume + dispatch, state-manager bookkeeping only (no adversarial gate -- a dispatch/status transition, not a phase/story gate) | `pipeline:` PAUSED->ACTIVE; Wave 2 (`S-cycle5-mention-resolution-wiring`) dispatched to per-story delivery via worktree `feat/cycle5-mention-resolution-wiring` (created from `develop` @ `5b00b31e`); STORY-INDEX.md flipped draft->in-progress on both rows (~L1235, ~L1652); `sprint-state.yaml`'s `cycle_005_adf_mentions` wave_2_status/story entry -> in-progress/dispatched. | counts unchanged (754/76/118/175); no DEC minted |

## Current Phase Steps (cycle-005 Burst 8 -- F4 WAVE 2 DISPATCH)

| Step | Status | Notes |
|------|--------|-------|
| Frontmatter: `pipeline:` PAUSED->ACTIVE | **DONE** | Human-authorized resume of the SESSION-WRAP pause. |
| Refresh `timestamp:` to the dispatch instant | **DONE** | `2026-09-09T19:43:02Z`. |
| `phase:`/`current_step:`/`last_amended:` verbatim-strict chain update | **DONE** | D-chain cite `D-053 latest brownfield.` and trajectory-tail `→1→3→0→2` preserved; no meta-commentary/clause-reordering/justification-suffix added. |
| Bump `version:` exactly one: 3.94->3.95 | **DONE** | No double-bump. |
| Verify worktree `feat/cycle5-mention-resolution-wiring` exists (created from `develop` @ `5b00b31e`) | **DONE** | Confirmed via `git worktree list`. |
| STORY-INDEX.md: flip `S-cycle5-mention-resolution-wiring` draft->in-progress (registry ~L1235, detail ~L1652) | **DONE** | Dependency `S-cycle5-mention-pure-conversion` SATISFIED/merged, F3-approved via DEC-347. No count change (754/76/118/175). |
| `sprint-state.yaml`: `cycle_005_adf_mentions` wave_2_status + story entry -> in-progress/dispatched | **DONE** | Reflects existing worktree + dispatch date. |
| Archive v3.94 Session Resume Checkpoint to `cycles/cycle-005/session-checkpoints.md` | **DONE** | "Superseded at" note; done BEFORE writing the new checkpoint. |
| Write exactly one new v3.95 Session Resume Checkpoint | **DONE** | Reflects ACTIVE pipeline, Wave 2 dispatched, next steps. |
| Append Phase Progress row `F4-WAVE2-DISPATCH-2026-09-09` | **DONE** | DISPATCHED, agent state-manager. |
| Recompute `wc -l` and refresh SIZE BUDGET banner | **DONE** | Line-count claim + dual-margin figures updated to match exactly. |
| Verify + include `sidecar-learning.md` in this atomic commit | **DONE** | Diff = append-only `Session ended at …` marker(s), consistent with the file's existing append-only pattern -- legitimate factory learning artifact. |
| Single atomic commit (`factory(phase-3):`) + push to `factory-artifacts` | **DONE** | Worktree ends clean (PC-12). |

(Burst 7's cycle-005 Current Phase Steps -- SESSION-WRAP PAUSE checkpoint (frontmatter `pipeline:` ACTIVE->PAUSED, verbatim-strict chain, v3.94 checkpoint archive+write, Phase Progress row, SIZE BUDGET refresh, sidecar-learning.md inclusion) -- folded into this pointer note; see `cycles/cycle-005/burst-log.md` Burst 7. Burst 6's cycle-005 Current Phase Steps -- record PR #793 merge fact, close the cycle-006 S-7.02 deferral `CYCLE6-LOW-STALE-CHECK-KILL-RATE-COMMENTS`, settle the badge-visibility research outcome, confirm pipeline position, archive v3.92, append Burst 6, frontmatter correction, write v3.93 checkpoint -- folded into this pointer note; see `cycles/cycle-005/burst-log.md` Burst 6. Burst 5's cycle-005 Current Phase Steps -- mint DEC-352, flip STORY-INDEX.md rows, update sprint-state.yaml wave tracking, record the interim-shippability-window + local-mutation-verify-partial standing items, update pipeline position, archive v3.91, append Burst 5, frontmatter correction, write v3.92 checkpoint -- similarly folded; see `cycles/cycle-005/burst-log.md` Burst 5. Burst 13's cycle-006 Current Phase Steps and earlier cycle-006 step history remain folded into pointer notes across the v3.79-v3.91 archives in `cycles/cycle-006/session-checkpoints.md`. Prior cycle-005/004/003/002/001 steps archived to their own `cycles/<cycle>/burst-log.md`.)

## Decisions Log

| ID | Decision | Rationale | Phase | Date | Made By |
|----|----------|-----------|-------|------|---------|
| DEC-352 | cycle-005 (`adf-mentions`) Wave-1 story `S-cycle5-mention-pure-conversion` (PR #778) **MERGED to `develop` via the >120-mutation escape-hatch ADMIN-BYPASS**, human-authorized, 2026-09-09. Squash-merge commit `708c8b32` ("feat(adf): pure markdown-mention conversion (Story A, #674) (#778)"). `develop` advanced `a9168212`->`708c8b32`. PR #778's `src/adf.rs` diff generated **281 in-diff mutants** (> the 120-mutant escalation threshold), so the cycle-006 sharded mutation gate correctly **ESCALATED** (Mutation Test Plan pass -> 8 shards skipped -> Mutation Testing Aggregate fail -> CI Gate fail) -- the FIRST real production exercise of the cycle-006 escape hatch. All 14 other checks passed (Test macos/ubuntu/windows, Coverage, Clippy ubuntu/windows, Deny, Format, MSRV, Mutation Test Plan, gitleaks, Signing Workflow Injection Guard, Spec Guards, dependency-review). Human reviewed split-below-120/defer/admin-bypass and chose **admin-bypass** on: (a) #778 already per-story adversarially converged (3 clean passes), pr-reviewer APPROVE, security-reviewer CLEAN (1 LOW deferred to Wave 2); (b) a local `cargo mutants --in-diff` safety-net run, started but stopped partway (~96 of 281 mutants completed) due to environment contention, showed 66 caught / **0 missed** / 21 timeout (environmental, not genuine survivors) / 9 unviable; (c) the advisory nightly full-scope run (`mutants-nightly.yml`) remains the ongoing net, with a follow-up to surface its kill-rate via `$GITHUB_STEP_SUMMARY` now queued (`research/mutation-testing-badge-visibility-2026-09-09.md`) -- **this follow-up was actioned at Burst 6 (below) via PR #793**. The admin-bypass merge itself was executed by the human directly in the GitHub UI -- the orchestrator's `gh pr merge --admin` was correctly blocked by the environment's permission classifier (an admin override of a red required check is a human-executed action, not an agent one) | Human reviewed the complete evidence package (per-story convergence, the partial-but-zero-missed local mutation signal, and the ongoing advisory nightly net) and judged the risk of merging a >120-mutant diff acceptable via admin-bypass rather than splitting the story below the threshold or deferring the merge | F4 (delivery) | 2026-09-09 | human (explicit admin-bypass authorization) |
...
**cycle-005 note (Bursts 1-8, sole active OPEN cycle, pipeline ACTIVE, DEC-namespace clean, max ID DEC-352 -- Bursts 6-8 minted no new DEC):** **DEC-344** (F1 APPROVED, Burst 1). **DEC-345**/**DEC-346** (F2-gate TIGHTENING + APPROVED, Burst 2, condensed). **DEC-347** (F3 APPROVED, Burst 3, condensed) -- 2-wave decomposition, accepted interim-shippability-window tradeoff. Wave 1 implemented + PR #778 opened, per-story adversarial convergence COMPLETE (Burst 4). **DEC-352 (Burst 5):** Wave 1 (`S-cycle5-mention-pure-conversion`) **MERGED** to `develop` via the >120-mutant escape-hatch **ADMIN-BYPASS**, human-authorized -- PR #778 squash-merged @ `708c8b32` (`a9168212`->`708c8b32`); Wave 2 (`S-cycle5-mention-resolution-wiring`) dependency **SATISFIED**, READY, next F4 work. **Burst 6 (no DEC minted):** a standalone maintenance/enhancement PR **#793** (`ci/mutation-nightly-visibility`, NOT a cycle-005 story) squash-merged to `develop` as `5b00b31e` (`708c8b32`->`5b00b31e`) -- closes cycle-006's S-7.02 deferral `CYCLE6-LOW-STALE-CHECK-KILL-RATE-COMMENTS` and settles the mutation-testing badge-visibility research outcome (option #1 landed; dynamic badge DEFERRED). **Burst 7 (no DEC minted):** a SESSION-WRAP PAUSE checkpoint (wrap skill Step 4) -- `pipeline:` ACTIVE->PAUSED; no pipeline-position change in substance. **Burst 8 (THIS BURST, no DEC minted):** human-authorized resume of the SESSION-WRAP pause -- `pipeline:` PAUSED->ACTIVE; cycle-005 Phase F4 Wave 2 (`S-cycle5-mention-resolution-wiring`) **DISPATCHED** to per-story delivery, worktree `feat/cycle5-mention-resolution-wiring` confirmed created from `develop` @ `5b00b31e`; STORY-INDEX.md and `sprint-state.yaml` updated to in-progress/dispatched. Pipeline position advances in substance for the first time since Burst 5's Wave-1 merge -- Wave 2 is now IN PROGRESS, not merely READY. The DEC-347 interim-shippability-window tradeoff remains OPEN, target closure = Wave 2's BC-X.7.010 preflight. cycle-005 (`adf-mentions`, #674) remains OPEN, Phase F4 IN PROGRESS, pipeline ACTIVE.

**cycle-006 note (Bursts 1-13, CLOSED, DEC-namespace clean at close, max ID DEC-351 as of cycle-close; superseded by DEC-352 above as the factory's current max ID):** **DEC-348** (F1 APPROVED, Burst 1). **DEC-349** (F2 gate APPROVED as-is, Burst 3). **DEC-350** (F3 gate APPROVED as-is, Burst 8) -- phase advanced F3->F4. F4 (delta implementation) reached Step-4.5 3-consecutive-clean (7 trios / 21 fresh passes / 6 fix rounds, Bursts 9-11), then was delivered and squash-merged into `develop` @ `a9168212` via PR #791 (Burst 12; pr-reviewer APPROVE, security-reviewer near-clean, all 24 CI checks passed incl. the sharded pipeline's first live production run). **DEC-351 (Burst 13):** F5/F6 completed with no separate human gate under the feature-mode convention; F7 (delta convergence) reached a 5-dimensional PASS and the human **APPROVED cycle-006's CLOSE at the F7 gate, with NO release cut**. The S-7.02 cycle-closing checklist was executed: **RECORD DEFERRALS ONLY** -- 6 items recorded as justified deferrals (see Drift / Standing Items); `F-PE-MED-001` and `R-F2` marked **RESOLVED/CLOSED**. **cycle-006 (`mutants-ci-sharding`) is CLOSED.** One of the 6 S-7.02 deferrals, `CYCLE6-LOW-STALE-CHECK-KILL-RATE-COMMENTS`, was itself subsequently **RESOLVED at cycle-005 Burst 6** by the standalone PR #793 (@ `5b00b31e`) -- see Drift/Standing Items. Full burst-by-burst detail: `cycles/cycle-006/burst-log.md` Bursts 1-13.
...
**NONE OPEN.** Zero Blocking Issues remain open anywhere in the factory as of this burst. cycle-006 is **CLOSED** (DEC-351) with zero open Blocking Issues; cycle-005 Wave 1's admin-bypass merge (DEC-352), Burst 6's standalone PR #793 merge, Burst 7's SESSION-WRAP PAUSE, and this burst's Wave 2 dispatch introduce no new Blocking Issue -- the DEC-347 interim-shippability-window tradeoff remains an *accepted, time-boxed* tradeoff, not a defect, tracked in **Drift / Standing Items** below, not here.
...
- `CYCLE6-LOW-STALE-CHECK-KILL-RATE-COMMENTS` -- **RESOLVED.** Both stale inline comments citing the retired "Check kill rate" step (`scripts/check-ci-gate.sh` ~L43-45, `.github/workflows/ci.yml` ~L100-101) were fixed by standalone PR #793's diff, squash-merged to `develop` @ `5b00b31e`. See Drift / Standing Items.
...
**S-7.02 CYCLE-CLOSING CHECKLIST DEFERRALS (cycle-006 close, Burst 13, DEC-351):** originally 6 items; 1 (`CYCLE6-LOW-STALE-CHECK-KILL-RATE-COMMENTS`) RESOLVED at cycle-005 Burst 6 (above) -- 5 remain open. Full itemized table with target + reason: see **Drift / Standing Items** below.
...
`cycle-005` (`adf-mentions`) Phase **F1 APPROVED** (DEC-344); Phase **F2 APPROVED** (DEC-345 tightening + DEC-346 approval); Phase **F3 APPROVED** (DEC-347); Phase **F4 (delta implementation) IN PROGRESS** -- Wave 1 (`S-cycle5-mention-pure-conversion`) **MERGED** 2026-09-09 via the >120-mutant escape-hatch ADMIN-BYPASS (**DEC-352**), PR #778 @ `708c8b32`; Wave 2 (`S-cycle5-mention-resolution-wiring`) dependency **SATISFIED**, **DISPATCHED** to per-story delivery. A standalone maintenance PR (**#793**, NOT a cycle-005 story) subsequently merged to `develop` @ `5b00b31e` (Burst 6), closing cycle-006's `CYCLE6-LOW-STALE-CHECK-KILL-RATE-COMMENTS` deferral and settling the badge-visibility research outcome. Session was **PAUSED** 2026-09-09 (Burst 7, SESSION-WRAP), then **RESUMED** the same day (Burst 8) with Wave 2 **DISPATCHED** to per-story delivery via worktree `feat/cycle5-mention-resolution-wiring` (created from `develop` @ `5b00b31e`). Pipeline is now **ACTIVE**. **cycle-005 is the sole OPEN cycle.** Full detail: `cycles/cycle-005/phase-f3-stories/` + `.factory/sprint-state.yaml` `cycle_005_adf_mentions` + `cycles/cycle-005/burst-log.md` Bursts 1-8.

`cycle-006` (`mutants-ci-sharding`) F1-F7 all **COMPLETE**, human-approved at every gate (**DEC-348 through DEC-351**). **NO RELEASE CUT** -- CI-infrastructure-only; the shipped `jr` binary is byte-identical; the next release rides cycle-005. **cycle-006 is CLOSED** -- historical. One of its 6 S-7.02 deferrals (`CYCLE6-LOW-STALE-CHECK-KILL-RATE-COMMENTS`) was subsequently RESOLVED at cycle-005 Burst 6. Full detail: `cycles/cycle-006/burst-log.md` Bursts 1-13 + `cycles/cycle-006/blocking-issues-resolved.md`.

**cycle-005 is the sole OPEN cycle** (Phase F4, Wave 1 merged, Wave 2 dispatched to per-story delivery, pipeline ACTIVE); cycle-001 through cycle-004 and cycle-006 are all CLOSED, historical.

## Concurrent Cycles

Six tracked cycles. `cycle-001` is CLOSED, historical. `cycle-002` (`field-dx`) is **CLOSED + RELEASED** (2026-09-01), historical. `cycle-003` (`auth-profile-dx`) is **CLOSED + RELEASED** (2026-09-03, DEC-333) as **`v0.7.0-dev.4`** @ `42e92b46`, historical. `cycle-004` (`windows-correctness`) is **CLOSED + RELEASED** (2026-09-06, DEC-343) as **`v0.7.0-dev.5`** @ `569d85a8`, historical. `cycle-006` (`mutants-ci-sharding`) is **CLOSED, NO RELEASE** (2026-09-09, DEC-348/349/350/351) -- F1-F7 all complete; PR #791 merged to `develop` @ `a9168212`; CI-infrastructure-only, shipped binary byte-identical, next release rides cycle-005; historical (one of its 6 S-7.02 deferrals subsequently RESOLVED via a standalone PR, see below). `cycle-005` (`adf-mentions`, GitHub #674) is **OPEN -- the sole active cycle** -- Phase F1 **APPROVED** (DEC-344), Phase F2 **APPROVED** (DEC-345/DEC-346), Phase F3 **APPROVED** (DEC-347), Phase F4 (delta implementation) **IN PROGRESS** -- Wave 1 (`S-cycle5-mention-pure-conversion`, **MERGED** 2026-09-09 via the >120-mutant escape-hatch ADMIN-BYPASS, **DEC-352**, PR #778 @ `708c8b32`) -> Wave 2 (`S-cycle5-mention-resolution-wiring`, dependency **SATISFIED**, **DISPATCHED** to per-story delivery), tracked in `.factory/sprint-state.yaml`'s `cycle_005_adf_mentions` section. Between the two waves, a standalone maintenance/enhancement PR **#793** (`ci/mutation-nightly-visibility`, NOT a cycle-005 story, no DEC minted) squash-merged to `develop` @ `5b00b31e`, 2026-09-09T18:35Z -- closes cycle-006's `CYCLE6-LOW-STALE-CHECK-KILL-RATE-COMMENTS` deferral and operationalizes the mutation-testing badge-visibility research (option #1 job-summary+docs landed; dynamic shields badge DEFERRED, not pursued). `develop`'s real tip is now **`5b00b31e`** (`708c8b32`->`5b00b31e`, Burst 6's PR #793 merge); `activation_head` frontmatter stays **`a9168212`** -- no release tag was cut. The standing auto-merge policy (DEC-330/DEC-331) and the `gh pr merge`/push MAIN-session-only constraint remain in effect for cycle-005's future story/fix PRs. **Pipeline is ACTIVE** (resumed 2026-09-09, Burst 8). Wave 2 (`S-cycle5-mention-resolution-wiring`) has been **DISPATCHED** to the standard per-story-delivery TDD pipeline (test-writer -> implementer -> demo-recorder -> pr-manager -> devops-engineer) via worktree `feat/cycle5-mention-resolution-wiring` (created from `develop` @ `5b00b31e`), including the human-required live-Jira E2E round-trip acceptance test (`H-NEW-MENTION-009`, not yet started). **Next:** Wave 2 per-story delivery in progress -> Wave 2 PR review/merge -> Wave-2 integration gate -> cycle-005 F5/F6/F7 -> eventual release decision (would ride both cycle-005 and cycle-006).

## Constraints Carried Forward

**cycle-005 (F4 WAVE 2 DISPATCH, Burst 8, THIS BURST, no DEC minted):** Human authorized resuming the SESSION-WRAP pause and dispatching cycle-005 Phase F4 Wave 2 (`S-cycle5-mention-resolution-wiring`) to per-story delivery. `pipeline:` PAUSED->ACTIVE; `phase:`/`current_step:`/`last_amended:` refreshed via the verbatim-strict chain (D-chain cite `D-053 latest brownfield.` and trajectory-tail `→1→3→0→2` preserved); `version:` 3.94->3.95. Worktree `feat/cycle5-mention-resolution-wiring` confirmed created from `develop` @ `5b00b31e`. STORY-INDEX.md flipped `S-cycle5-mention-resolution-wiring` status draft->in-progress on both the registry row (~L1235) and detail row (~L1652) -- dependency `S-cycle5-mention-pure-conversion` SATISFIED/merged, F3-approved via DEC-347; no count change. `sprint-state.yaml`'s `cycle_005_adf_mentions` wave_2_status and the story entry updated to in-progress/dispatched, recording the worktree and dispatch date. The v3.94 Session Resume Checkpoint was archived to `cycles/cycle-005/session-checkpoints.md` with a "Superseded at" note ahead of this Write; exactly one new v3.95 checkpoint was written reflecting the ACTIVE pipeline and dispatched Wave 2. A Burst 8 entry was appended to `cycles/cycle-005/burst-log.md`. Counts unchanged (754/76/118/175); `activation_head`/`activation_version` unchanged (`a9168212`/`v0.7.0-dev.5`). No DEC minted -- a dispatch/status transition, not a phase-gate decision. **Pipeline is ACTIVE.**

**cycle-005 (SESSION-WRAP PAUSE, Burst 7, historical, superseded by the dispatch above):** Human directed a wrap skill Step 4 PAUSE checkpoint to make pipeline state durable across a session boundary. `pipeline:` ACTIVE->PAUSED; `phase:`/`current_step:`/`last_amended:` refreshed via the verbatim-strict chain (D-chain cite `D-053 latest brownfield.` and trajectory-tail `→1→3→0→2` preserved); `version:` 3.93->3.94. No pipeline work occurred this burst -- Wave 2 (`S-cycle5-mention-resolution-wiring`) remained READY/next, dependency SATISFIED, NOT yet dispatched. The v3.93 Session Resume Checkpoint was archived to `cycles/cycle-005/session-checkpoints.md` with a "Superseded at" note ahead of this Write; exactly one new v3.94 checkpoint was written recording the resume point. A Burst 7 entry was appended to `cycles/cycle-005/burst-log.md`. Counts unchanged (754/76/118/175); `activation_head`/`activation_version` unchanged (`a9168212`/`v0.7.0-dev.5`). The concurrently-modified `sidecar-learning.md` (two appended session-end markers, dirty since earlier in the session) was verified as a legitimate factory learning artifact (consistent with its existing append-only pattern) and committed in this same atomic commit, ending the factory-artifacts working tree CLEAN (PC-12). **Pipeline was PAUSED as of this burst** -- since resumed, see the entry above.

**cycle-005 (standalone maintenance PR #793 MERGED, Burst 6, historical, superseded in recency by the pause/resume above):** A standalone maintenance/enhancement PR (`#793`, branch `ci/mutation-nightly-visibility`, NOT a cycle-005 story) squash-merged to `develop` as `5b00b31e` ("ci: surface nightly mutation kill-rate in job summary + docs (#793)"), 2026-09-09T18:35Z; `develop` advanced `708c8b32`->`5b00b31e`. Normal merge -- clean CI, no escalation/admin-bypass needed (~0 in-diff mutants, since no `src/` file changed). pr-reviewer **APPROVE**. Diff: `.github/workflows/mutants-nightly.yml` (adds a pooled kill-rate + caught/missed/timeout/unviable table to `$GITHUB_STEP_SUMMARY` in the `mutants-nightly-report` job, advisory/non-gating, still exit 0), `README.md` (new "Mutation testing" section), `docs/specs/cargo-mutants-policy.md` (nightly-summary pointer), `scripts/check-ci-gate.sh` + `.github/workflows/ci.yml` (comment-only stale "Check kill rate" citation fixes). Local+CI verification green (`ci_gate_completeness` 101/101, `actionlint` clean, `mutants-aggregate` self-test 25/25). **Closes** the cycle-006 S-7.02 deferral `CYCLE6-LOW-STALE-CHECK-KILL-RATE-COMMENTS` (both stale comments fixed). **Settles** the mutation-testing badge-visibility research outcome (`research/mutation-testing-badge-visibility-2026-09-09.md`'s option #1, job-summary+docs, is now landed; the dynamic shields-badge option is DEFERRED, not pursued -- settled, not re-opened). Strengthens the advisory-nightly net that cycle-005 Wave 1's escape-hatch bypass (DEC-352) relies on. **No DEC minted** (small merged enhancement, not a phase-gate or story decision). Counts unchanged (754/76/118/175). `activation_head`/`activation_version` unchanged (`a9168212`/`v0.7.0-dev.5`) -- no release tag cut, though `develop`'s real tip is now `5b00b31e`. Pipeline position unchanged in substance at this point -- Wave 2 remained READY/next until dispatched at Burst 8.

**cycle-005 (Wave 1 MERGED via >120-mutant escape-hatch ADMIN-BYPASS, DEC-352, Burst 5, historical):** Story `S-cycle5-mention-pure-conversion` (13 pts, Wave 1) reached per-story adversarial convergence (3 clean passes) pre-merge; PR #778's `src/adf.rs` diff generated 281 in-diff mutants (> the cycle-006 120-mutant escalation threshold), correctly ESCALATING the sharded mutation gate (Mutation Test Plan pass -> 8 shards skipped -> Aggregate fail -> CI Gate fail) while all 14 other checks passed. Human reviewed the evidence (3-clean convergence; pr-reviewer APPROVE; security-reviewer CLEAN, 1 LOW deferred; a partial local `--in-diff` safety-net run showing 66 caught / 0 missed / 21 timeout-environmental / 9 unviable of ~96/281 completed; the ongoing advisory nightly full-scope net) and chose **ADMIN-BYPASS** over split-below-120/defer. PR #778 squash-merged into `develop`, merge commit `708c8b32` (`a9168212`->`708c8b32`). STORY-INDEX.md flipped both `S-cycle5-mention-pure-conversion` rows to done; `sprint-state.yaml`'s `cycle_005_adf_mentions` wave_1 -> done, wave_2 -> ready. Wave 2 (`S-cycle5-mention-resolution-wiring`) dependency **SATISFIED**. The DEC-347 interim-shippability-window tradeoff remains **OPEN** -- see Drift/Standing Items. Full detail: `cycles/cycle-005/burst-log.md` Burst 5.
...
**Date:** 2026-09-09. **Pipeline: ACTIVE** (resumed at Burst 8, human-authorized dispatch). **Position:** cycle-005 (`adf-mentions`) Phase F4 (delta implementation) -- Wave 1 (`S-cycle5-mention-pure-conversion`) **MERGED** (PR #778 @ `708c8b32`, **DEC-352**, escape-hatch admin-bypass); standalone maintenance PR #793 (nightly mutation visibility) **MERGED** @ `5b00b31e`; Wave 2 (`S-cycle5-mention-resolution-wiring`, 13 pts, HIGH, `depends_on` SATISFIED) is **IN-PROGRESS / DISPATCHED** to per-story delivery via worktree `feat/cycle5-mention-resolution-wiring` (created from `develop` @ `5b00b31e`). `develop` @ `5b00b31e`. **NEXT action** = continue Wave 2 per-story delivery (stubs/failing tests Red Gate -> TDD -> Step-4.5 adversarial convergence -> PR), which carries a human-required live-Jira E2E round-trip `H-NEW-MENTION-009`.

**Convergence counter:** N/A -- Wave 2's own per-story adversarial convergence loop has not yet begun (dispatch just occurred this burst); Wave 1's convergence (3-clean, Burst 4) stands unmodified, historical.

**In-flight work:** Wave 2 (`S-cycle5-mention-resolution-wiring`) dispatched to per-story delivery this burst -- worktree `feat/cycle5-mention-resolution-wiring` exists (branch created from `develop` @ `5b00b31e`); a concurrent test-writer/implementer pass is already active in that worktree (observed via a fresh `regression-state.json` test-run record for `mutants_glob_existence`) as of this checkpoint. No open PRs yet.

**Pending human decisions / unresolved:** (1) an OPEN offer to manually trigger `mutants-nightly.yml` (workflow_dispatch) so the operator can see the new job-summary kill-rate before the next 08:00 UTC scheduled run -- not yet answered; (2) the dynamic-shields kill-rate README badge remains DEFERRED (settled, do not re-open); (3) the `CLAUDE_AUTOCOMPACT_PCT_OVERRIDE` settings.json advisory (add at 70) surfaced by `check-state-health`. No blockers on Wave 2 dispatch itself -- DEC-347 already approved the 2-wave decomposition.
...
**Resume command:** `/vsdd-factory:rehydrate-wave` then `/vsdd-factory:next-step` (or continue Wave 2 per-story delivery directly in the existing worktree).

**Tracked non-blocking follow-ups:** unchanged from v3.94 -- `VP-COUNT-RECONCILIATION`, `ADR-COUNT-CANONICAL-GUARD-GAP`, `FACTORY-HOOK-FUEL-EXHAUSTED` (all pre-existing). cycle-006's S-7.02 close-out deferrals: 5 remain open (unchanged, historical -- see Drift/Standing Items); the 6th, `CYCLE6-LOW-STALE-CHECK-KILL-RATE-COMMENTS`, was RESOLVED at Burst 6 by PR #793. `INTERIM-SHIPPABILITY-WINDOW-CYCLE5-W1` (unchanged, still OPEN, target Wave 2's BC-X.7.010 preflight) and `CYCLE5-W1-LOCAL-MUTATION-VERIFY-PARTIAL` (unchanged, LOW, informational) -- see **Drift / Standing Items**. The nightly-kill-rate `$GITHUB_STEP_SUMMARY` badge-visibility follow-up remains **ACTIONED** (option #1 landed via PR #793); the dynamic shields-badge option remains recorded **DEFERRED, not pursued** -- settled outcome.

**Counts: total_bcs 754; VP count 76 tracked running total; holdout scenarios 118; total_stories 175** (all counts unchanged this burst -- a dispatch/status transition, no spec/story authorship).

**Superseded checkpoints:** the prior cycle-005 Burst-7 checkpoint (v3.94, 2026-09-09 -- SESSION-WRAP PAUSE) is superseded in place by this checkpoint and archived to `cycles/cycle-005/session-checkpoints.md` ahead of this Write (the cycle-005 burst that produced it), with a "Superseded at" note explaining this is the resume + dispatch of Wave 2 that the pause was awaiting. Earlier archives (cycle-006 v3.79 Burst-1 through v3.91 Burst-13; cycle-005 v3.75-v3.78, v3.92, v3.93; cycle-004 v3.53-v3.74, cycle-003 v3.31-v3.52, cycle-002 v3.23-v3.29 and earlier, cycle-001 v3.05) remain at their respective `cycles/<cycle>/session-checkpoints.md` files, unchanged this burst.
...
| cycle-005 burst history | `cycles/cycle-005/burst-log.md` (Burst 1 = cycle OPENED, F1 APPROVED (DEC-344); Burst 2 = F2 APPROVED (DEC-346) with TIGHTENING (DEC-345); Burst 3 = F3 APPROVED (DEC-347); Burst 4 = F4 Wave 1 implemented + convergence COMPLETE + PR #778 opened + SESSION WRAP; Burst 5 = F4 Wave 1 MERGED to `develop` via the >120-mutant escape-hatch ADMIN-BYPASS (DEC-352), PR #778 @ `708c8b32`, Wave 2 UNBLOCKED; Burst 6 = standalone maintenance PR #793 (`ci/mutation-nightly-visibility`) MERGED @ `5b00b31e`, closes cycle-006 S-7.02 deferral `CYCLE6-LOW-STALE-CHECK-KILL-RATE-COMMENTS`, settles badge-visibility research outcome, no DEC minted; Burst 7 = SESSION-WRAP PAUSE checkpoint, `pipeline:` ACTIVE->PAUSED, no DEC minted, Wave 2 remains next; **Burst 8 (2026-09-09, this Write) = F4 WAVE 2 DISPATCH, `pipeline:` PAUSED->ACTIVE, Wave 2 (`S-cycle5-mention-resolution-wiring`) dispatched to per-story delivery via worktree `feat/cycle5-mention-resolution-wiring` created from `develop` @ `5b00b31e`, no DEC minted**) |
...
| cycle-005 F4 wave tracking | `.factory/sprint-state.yaml` `cycle_005_adf_mentions:` section (Wave 1 `done`, Wave 2 `in-progress`/dispatched) |
...
| cycle-005 Wave-1 merge admin-bypass evidence | Decisions Log `DEC-352` row (full escape-hatch rationale); `cycles/cycle-005/burst-log.md` Burst 5 |
| cycle-005 standalone maintenance PR #793 evidence (Burst 6) | GitHub PR #793 (squash-merged 2026-09-09T18:35Z, branch `ci/mutation-nightly-visibility` -> `develop` @ `5b00b31e`); `code-delivery/pr-review.md` (pr-reviewer fresh-eyes APPROVE); `research/mutation-testing-badge-visibility-2026-09-09.md` (option #1 recommendation now landed; dynamic badge DEFERRED); `cycles/cycle-005/burst-log.md` Burst 6 |
| cycle-005 SESSION-WRAP PAUSE evidence (Burst 7) | `cycles/cycle-005/burst-log.md` Burst 7; `cycles/cycle-005/session-checkpoints.md` (v3.93 archived with "Superseded at" note) |
| cycle-005 F4 Wave 2 dispatch evidence (Burst 8, NEW this burst) | `cycles/cycle-005/burst-log.md` Burst 8; `cycles/cycle-005/session-checkpoints.md` (v3.94 archived with "Superseded at" note); worktree `.worktrees/S-cycle5-mention-resolution-wiring` on branch `feat/cycle5-mention-resolution-wiring` (created from `develop` @ `5b00b31e`) |
| cycle-005 session checkpoints | `cycles/cycle-005/session-checkpoints.md` (v3.75-v3.78, v3.92, v3.93, v3.94 archived) |
...
**cycle-005 Burst 6 (2026-09-09) -- standalone maintenance PR #793 closes a cycle-006 deferral + settles a research follow-up:**

| Item | Class | Resolution |
|------|-------|------------|
| `CYCLE6-LOW-STALE-CHECK-KILL-RATE-COMMENTS` | doc-hygiene (was: open S-7.02 deferral) | **RESOLVED.** Both stale inline comments citing the retired "Check kill rate" step (`scripts/check-ci-gate.sh` ~L43-45, `.github/workflows/ci.yml` ~L100-101) fixed by PR #793's diff, squash-merged to `develop` @ `5b00b31e`. Removed from the open S-7.02 deferrals table below; see Blocking Issues for the resolution record. |
| Mutation-testing badge-visibility follow-up | research recommendation | **SETTLED.** `research/mutation-testing-badge-visibility-2026-09-09.md`'s option #1 (job-summary + docs) is now landed via PR #793. The dynamic shields-badge option is recorded **DEFERRED, not pursued** -- this is the settled outcome and should not be re-opened without a fresh product decision. |

**cycle-005 Wave 1 delivery -- standing items (Burst 5, DEC-352, unchanged this burst):**

| Item | Class | Target | Reason |
|------|-------|--------|--------|
| `INTERIM-SHIPPABILITY-WINDOW-CYCLE5-W1` | accepted tradeoff (DEC-347), OPEN | cycle-005 Wave 2 (`S-cycle5-mention-resolution-wiring`) | Wave 1 shipped the pure bracket-mention conversion WITHOUT the effectful preflight/resolution wiring (per DEC-347's accepted, time-boxed tradeoff) -- the unvalidated-bracket-conversion window remains OPEN (Wave 1 merged, Wave 2's BC-X.7.010 preflight NOT yet landed -- Wave 2 dispatched to per-story delivery at Burst 8). Wave 2 closes it. |
...
**S-7.02 CYCLE-CLOSING CHECKLIST DEFERRALS (cycle-006 close, Burst 13, DEC-351) -- human chose RECORD DEFERRALS ONLY, NO follow-up stories opened; originally 6 items, now 5 open (1 RESOLVED, see above):**
