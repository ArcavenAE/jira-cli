...
project: jira-cli
mode: brownfield
current_step: "SOH-ATTACHMENTS-1 F2 spec package AUTHORED (spec v1.3.44, BC 651, ADR-0017); security APPROVE (final); consistency CONSISTENT (5 rounds); adversarial convergence loop DISPATCHED."
...
<!--
  ...
  Hard cap (500 lines) margin from soft-target = 500 - 345 = 155; margin from actual = 500 - 345 = 155 (D-446(c) dual-margin form). 345 lines (wc-l).
  Hard cap: 500 lines.
-->
...
| **Last Updated** | 2026-07-15: SOH-ATTACHMENTS-1 F2 authoring burst COMPLETE — 27 BCs (spec v1.3.44, BC 651, ADR-0017 Accepted); security APPROVE; consistency CONSISTENT (5 rounds r1..r5); adversarial convergence DISPATCHED. develop @ 56d5126. |
| **Current Phase** | Phase 3 — **SOH-ATTACHMENTS-1 F2 AUTHORING COMPLETE (2026-07-15)**. Spec v1.3.44. Stories **111**. develop @ 56d5126. BC **651**. Holdouts **88**. VP **30**. |
...
| BC-INDEX-9TH-SURFACE | process-gap | BC-INDEX.md coverage statistics not covered by check-bc-cumulative-counts.sh. RECURRENCE COUNT: 6 (+2 SOH-ATTACHMENTS-1 F2: CONS-576-004 Source-column staleness class + NEW-R5-001 Coverage-note enumeration staleness; remedy candidate: extend check-bc-citation-symbols.sh to BC-INDEX Source column). | LOW | OPEN — guard-extension candidate |
...
Current project index versions: BC-INDEX v6.13 / VP-INDEX v0.82 / STORY-INDEX v1.02 / ARCH-INDEX v0.16 (ARCH-INDEX.md bootstrapped 2026-07-15 alongside adr-index.md — old "ARCH-INDEX v0.16" label maps to adr-index lineage)
...
Trajectory-tail: →1L→0→0→0→F6-GO→F7-APPROVED→RELEASED (F5 adversarial window CONVERGED; F6 gate PASS GO; F7 gate APPROVED D-176; RELEASED 2026-07-15 @ 56d5126).
...
| **Position** | SOH-ATTACHMENTS-1 F1 APPROVED (DEC-179). F2 spec evolution in flight. develop @ 56d5126 (v0.6.0-dev.10). BC 624; Stories 111; Holdouts 88; VP 30. No feature worktrees yet. |
...
<!-- State snapshot: SOH-ATTACHMENTS-1 F1 GATE APPROVED (DEC-179). F2 spec evolution in flight. develop @ 56d5126. BC 624; Stories 111. Holdouts 88. VP 30. No feature worktrees yet. Pending human PR actions: #625, #591, #574, #598/#599, #612, #624. RESUME INTENT: F2 spec evolution continues; pending human PRs. -->
...
**Step 3 — IN PROGRESS: SOH-ATTACHMENTS-1 F1 GATE APPROVED (2026-07-15, DEC-179); F2 SPEC EVOLUTION DISPATCHED:**
