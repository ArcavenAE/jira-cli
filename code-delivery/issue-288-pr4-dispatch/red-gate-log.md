...
| AC-012 (BC-1.3.023, BC-X.3.005, H-NEW-JSM-RT-003) | `test_jsm_create_401_hint_contains_write_servicedesk_request` + `test_platform_create_401_no_jsm_scope_hint` | tests/issue_create_jsm.rs | FAIL + PASS (negative guard correctly passes) |
