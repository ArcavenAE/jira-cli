...
- `.factory/specs/prd/BC-INDEX.md` (MODIFIED): Section 3.8 heading retitled; BC-3.8.001 Summary qualified with DEC-188 caveat; BC-3.8.012/013 rows marked [AMENDED DEC-188 2026-07-25] with new summary; BC-3.3.001 row amended 2026-05-19 annotation scoped with past-tense date range (2026-05-19..2026-07-25); `index_version` v6.44 → v6.45; `last_updated` updated.
