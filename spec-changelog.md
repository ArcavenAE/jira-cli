...
- `.factory/specs/prd/holdout-scenarios.md` (MODIFIED): `total_holdouts` 83 → 87;
  ...
  SOH-COMMENT-CRUD-1; intro count 83 → 87; Group 15 added with H-NEW-COMMENT-001
  ...
  H-NEW-COMMENT-004 (view roundtrip + 404 exit 64, BC-3.5.010).
