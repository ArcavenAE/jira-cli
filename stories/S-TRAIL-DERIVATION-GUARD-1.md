...
risk_mitigations:
  - "Scoped as an evaluate-then-implement story, not a pre-committed tooling choice: this
     ...
     family with a --self-test convention (D-148/D-150), but a Rust tests/*.rs integration test
