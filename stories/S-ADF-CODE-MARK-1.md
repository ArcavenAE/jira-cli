...
changelog:
  - "1.9 (2026-07-08): DELIVERED — PR #593 squash-merged by human @ 7ba4cf4 (D-128 honored). F4 full delivery: Red Gate verified (8 RED anchors, all CONFIRMED-INPUT), 8 commits, Step 4.5 CONVERGED STRICT (4 passes, window p2/p3/p4), 992 lib + 49 integration tests green, mutation gate PASS (first real code-diff exercise), security 1 LOW, pr-reviewer APPROVE cycle 1, 12/12 AC demos. Closes issue #571 and the BC-7.2.007 EC-2 follow-up deferred from #474."
  - "1.8 (2026-07-08): F3 gate approved (human) — status draft→ready. F3 CONVERGED under STRICT (D-160): 10 passes / 6 fix rounds, clean window p8/p9/p10 on v1.7. F4 dispatch authorized; Step 4.5 criterion: STRICT (human ruling)."
