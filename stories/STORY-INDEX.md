...
| S-QUEUE-BC-1 | Author document-as-is BCs for `jr queue list` / `jr queue view` (BC-X.8.008, BC-X.8.009) — resolves S-JSM-E2E-1 AC-001/AC-003 traceability orphan | (new BCs — pending PO authorship) | — | **draft** — follow-up created 2026-06-02; blocked on BC authorship | small (TBD) |
...
| S-QUEUE-BC-1 | feature-followup (draft follow-up; queue BC orphan; 60→61; 2026-06-02) | /Users/zious/Documents/GITHUB/jira-cli/.factory/stories/S-QUEUE-BC-1-contract-queue-commands.md |
