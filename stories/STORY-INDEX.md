...
| S-2.06 | Worklog timeSpent server-side parsing + CMDB cache tuple pin | NFR-R-C, BC-X.5.009, BC-6.2.013 | — | draft | small | <!-- v2.0.0 2026-05-08: pivot from admin-only timetracking config fetch to timeSpent string passthrough; see .factory/research/S-2.06-jira-timetracking-verification.md --> |
