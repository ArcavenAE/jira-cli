...
| S-QUEUE-BC-1 | Author document-as-is BCs for `jr queue list` / `jr queue view` (BC-X.8.008, BC-X.8.009) — resolves S-JSM-E2E-1 AC-001/AC-003 traceability orphan | BC-X.8.008, BC-X.8.009 | — | **CONVERGED / merge-pending** — BC-X.8.008/009 authored; 10-pass hybrid adversarial review (3 consecutive clean 8/9/10); S-JSM-E2E-1 re-anchored; PR #478 open → develop (2026-06-08) | small (2 SP) |
...
| S-QUEUE-BC-1 | feature-followup (CONVERGED/merge-pending; BC-X.8.008/009 authored; PR #478 open → develop; 2026-06-08) | /Users/zious/Documents/GITHUB/jira-cli/.factory/stories/S-QUEUE-BC-1-contract-queue-commands.md |
