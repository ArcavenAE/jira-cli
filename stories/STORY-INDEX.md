...
last_updated: 2026-05-28 (S-428 added; feature mode F1+F2; 52→53)
...
| S-428 | Wiremock-only refactor: extract `resolve_cloud_id` + rewrite tests #4/#5/#6 in-process (closes #428) | — (no new BCs; BC-1.5.038 unchanged) | — | **ready** — F1+F2 complete (2026-05-28); awaiting F3 dispatch | small (3 SP) |
...
| S-428 | feature-followup (feature mode F1+F2 complete; F3 pending) | /Users/zious/Documents/GITHUB/jira-cli/.factory/stories/S-428-wiremock-only-disambiguation.md |
