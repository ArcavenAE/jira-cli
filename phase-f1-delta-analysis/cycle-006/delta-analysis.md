...
| `ci-gate.needs` (ci.yml line ~678) | **MODIFIED** | `mutants` → `mutants-aggregate` in the `needs:` array. Per D-096/097 (CLAUDE.md), this MUST NOT be wired directly into branch protection — only via `ci-gate.needs`, exactly as today. |
