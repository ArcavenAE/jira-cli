...
- Behavioral contracts: `bc-3-issue-write.md` (BC-3.3.010/011, BC-3.4.026-031, BC-3.8.008
  amendment, BC-3.8.012 reversal — governance-flagged separately as D-310 (renumbered from the
  initially-proposed D-307, which was already cycle-001's), not an architecture decision this
