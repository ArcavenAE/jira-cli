...
| SS-03 | HTTP Client Core | `src/api/client.rs`, `src/api/auth.rs`, `src/api/auth_embedded.rs`, `src/api/pagination.rs`, `src/api/rate_limit.rs`, `src/api/refresh_coordinator.rs` |
