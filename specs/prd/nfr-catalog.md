...
| NFR-SCA-2 | Scalability | LOW | FIX-IN-CYCLE (design accepted, cycle-003 `auth-profile-dx`, D-317; ADR-0011 amendment; F4 implementation pending) | BC-6.2.015 |
...
- FIX-IN-CYCLE: 1 (1 LOW: NFR-SCA-2 — cycle-003 `auth-profile-dx` D-317, 2026-09-01; design accepted via ADR-0011 amendment (Deferred → Accepted), `Profile(String)` newtype; F4 implementation story `S-cycle3-adr0011-newtype` pending; see BC-6.2.015 amended)
