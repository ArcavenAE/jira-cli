...
Breakdown:
- 660 = sum of per-file `total_bcs` values (canonical; see per-file table above)
- 430 of 660 are individually-bodied (have a `#### BC-` heading)
...
- BC-X.4.009 (ADV-P1-029) is a `#### BC-` heading in cross-cutting.md; it is
  included in cross-cutting's `total_bcs: 151` and in the **660 sum**.
  It does NOT add +1 beyond the 656.
  _(Note updated 2026-08-13 F2 spec evolution issue #668: 660 total after +2 BCs BC-2.2.032 +
  BC-2.3.039; was 658 before this addition; prior note: 658 total after +1 BC BC-X.13.007
