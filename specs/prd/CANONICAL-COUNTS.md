...
last_verified: "2026-06-08 (BC-7.2.007..008 added issue #474 markdown subsup + heading-attr; 592 total, bc-7 87/41)"
---
...
| bc-7-output-render.md | 41 | 41 | YES |
| cross-cutting.md | 76 | 76 | YES |
| **Total individually-bodied** | **360** | — | — |
...
| bc-7-output-render.md | 87 |
| cross-cutting.md | 142 |
| **Sum** | **592** |

### Grand total

**Canonical grand total: 592** (+4 BC-7.4.013-016 added 2026-05-08 via Fix-PR A `28b0f35`; +1 BC-2.6.050 added 2026-05-13 via issue #350; +1 BC-2.6.051 added 2026-05-14 via issue #365; +1 BC-3.4.009 added 2026-05-15 via issue #340 F2; +18 BC-3.8.001..010 + BC-X.12.001..008 added 2026-05-18 via issue #288 F2+F1d; +3 BC-3.8.011..013 added 2026-05-19 via issue #288 F1d + issue #383 F2; +4 BC-3.8.014..015 + BC-X.8.006..007 added 2026-05-19 via issue #384 F2; +2 BC-3.8.016..017 added 2026-05-20 via issue #385 F2; +2 BC-3.4.010..011 added 2026-05-20 via issue #388 F2; +3 BC-3.4.012..014 added 2026-05-21 via issue #398 F2; +3 BC-3.4.015..017 added 2026-05-22 via issue #396 F2; +2 BC-3.4.018..019 added 2026-06-01 via issue #331 F2; +1 BC-3.2.013 added 2026-06-03 via jsm-resolution-required F2; +1 BC-7.2.006 added 2026-06-08 via issue #470 listItem content-model conformance; +2 BC-X.8.008..009 added 2026-06-08 via S-QUEUE-BC-1 queue list/view document-as-is; +1 BC-3.2.014 added 2026-06-08 via fix-bulk-transition-schema bulkTransitionInputs wrapper; +2 BC-7.2.007..008 added 2026-06-08 via issue #474 markdown subsup + heading-attr)

_Note: BC-INDEX.md `total_bcs` header updated to 592 to match this file. CANONICAL-COUNTS.md carries the per-file sum as the primary source of truth. (+2 BC count change since last verified — BC-7.2.007..008 added via issue #474 markdown subsup + heading-attr 2026-06-08)_

Breakdown:
- 592 = sum of per-file `total_bcs` values (canonical; see per-file table above)
- 360 of 592 are individually-bodied (have a `#### BC-` heading)
...
| bc-07-output-render.md | 85 | bc-7-output-render.md | 87 | PENDING (L2 bc_count not yet bumped; L3 +2 BC-7.2.007..008 added 2026-06-08 via issue #474) |
