...
| bc-2-issue-read.md | 72 | 72 | YES |
| bc-3-issue-write.md | 115 | 115 | YES |
...
| bc-2-issue-read.md | 114 |
| bc-3-issue-write.md | 144 |
...
Breakdown:
- 699 = sum of per-file `total_bcs` values (canonical; see per-file table above)
- 469 of 699 are individually-bodied (have a `#### BC-` heading)
...
- BC-X.4.009 (ADV-P1-029) is a `#### BC-` heading in cross-cutting.md; it is
  included in cross-cutting's `total_bcs: 151` and in the **699 sum**.
  It does NOT add +1 beyond the 656.
  _(Note updated 2026-08-15 F2 spec evolution, component-management bundle, issues
  #604/#605/#606/#608: 699 total after +38 BCs (bc-8-components.md NEW FILE +28;
...
| bc-02-issue-read.md | 108 | bc-2-issue-read.md | 114 | PENDING (L2 not bumped by the 2026-08-15 F2 component-management delta — F2 touched L3 only, same posture as bc-01; prior: YES, bumped 2026-08-13; +2 BCs BC-2.2.032 + BC-2.3.039 added F2 issue #668 duedate feature; prior: bumped 2026-07-15; +12 BCs BC-2.7.001..012 added SOH-ATTACHMENTS-1 F2 DEC-179) |
| bc-03-issue-write.md | 140 | bc-3-issue-write.md | 144 | PENDING (L2 not bumped by the 2026-08-15 F2 component-management delta — F2 touched L3 only, same posture as bc-01; prior: YES, bumped 2026-07-15; +14 BCs BC-3.9.001..014 added SOH-ATTACHMENTS-1 F2 DEC-179; +6 BCs BC-3.9.015..020 added adversary pass-1 round B 2026-07-15) |
