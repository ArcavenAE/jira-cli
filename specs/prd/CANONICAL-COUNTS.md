...
|------|------------------------|----------------------------------|--------|
| bc-1-auth-identity.md | 60 | 60 | YES |
...
**Canonical grand total: 733** (+2 BC-1.1.016 + BC-1.4.034 added 2026-09-01 via cycle-003
...
Breakdown:
- 733 = sum of per-file `total_bcs` values (canonical; see per-file table above)
- 503 of 733 are individually-bodied (have a `#### BC-` heading)
- 230 are range-collapsed (counted in cumulative claim, no individual heading; unchanged — the
  2026-09-01 cycle-003 `auth-profile-dx` F2-gate FIX round (bc-1 +2: BC-1.1.016 + BC-1.4.034) and
  the earlier same-day F2 spec evolution addition (bc-1 +12, bc-6 +1) are entirely
...
- BC-X.4.009 (ADV-P1-029) is a `#### BC-` heading in cross-cutting.md; it is
  included in cross-cutting's `total_bcs: 155` and in the **733 sum**.
  It does NOT add +1 beyond the 656.
  _(Note updated 2026-09-01 F2-gate FIX round, cycle-003 `auth-profile-dx` (same day): 733 total
...
|---------|----------------------------|---------|--------------|----------|
| bc-01-auth-identity.md | 57 | bc-1-auth-identity.md | 71 | PENDING (L2 not bumped by the 2026-09-01 cycle-003 `auth-profile-dx` F2-gate FIX round — F2/fix touched L3 only, same posture as prior bc-1 deltas; +2 BCs BC-1.1.016 + BC-1.4.034 added same-day fix round; +12 BCs BC-1.1.013..015 + BC-1.2.048..051 + BC-1.4.031..033 + BC-1.6.047 added DEC-312..325/ADR-0020; prior: PENDING since the 2026-08-13 F2 bucket1-defects delta) |
