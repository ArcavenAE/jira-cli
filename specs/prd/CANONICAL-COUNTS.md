...
Breakdown:
- 707 = sum of per-file `total_bcs` values (canonical; see per-file table above)
- 477 of 707 are individually-bodied (have a `#### BC-` heading)
...
- BC-X.4.009 (ADV-P1-029) is a `#### BC-` heading in cross-cutting.md; it is
  included in cross-cutting's `total_bcs: 151` and in the **707 sum**.
  It does NOT add +1 beyond the 656.
  _(Note updated 2026-08-21 F2 spec evolution, list-read-ergonomics bundle, issues
