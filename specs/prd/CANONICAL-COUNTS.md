...
- Group 19 (Attachment Write, SOH-ATTACHMENTS-1 adversary pass-1 round B + P4-014 + P14-001 + P15-002, 2026-07-15/2026-07-16): H-NEW-ATTACHMENT-001..H-NEW-ATTACHMENT-010 (BC-2.7.001/007/008/010/011 + BC-3.9.001/003/005/015..020; P15-002/R3.12 adds H-NEW-ATTACHMENT-010; issues #576 #585) — +10

_Note: holdout-scenarios.md frontmatter `total_holdouts: 98` counts all holdout entries; the grep count of `^### H-` headings also returns 98. The frontmatter count (98) is authoritative. Last reconciled: 2026-07-16 (SOH-ATTACHMENTS-1 P15-002/R3.12; +H-NEW-ATTACHMENT-010 — BC-3.9.017 EC-3.9.017-9 non-interactive ≥1-match --replace-existing exit-64 pin)._
