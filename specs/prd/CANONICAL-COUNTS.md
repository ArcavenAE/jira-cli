...
last_verified: "2026-07-07 (BC-7.2.015 added ADF code-mark exclusivity issue #571; BC-7.2.007 EC-2 modified; 612 total)"
---
...
| cross-cutting.md | 82 | 82 | YES |
| **Total individually-bodied** | **382** | — | — |
...
- BC-X.4.009 (ADV-P1-029) is a `#### BC-` heading in cross-cutting.md; it is
  included in cross-cutting's `total_bcs: 148` and in the **612 sum**.
  It does NOT add +1 beyond the 611.
