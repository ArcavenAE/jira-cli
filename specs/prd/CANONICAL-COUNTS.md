...
Breakdown:
- 661 = sum of per-file `total_bcs` values (canonical; see per-file table above)
- 431 of 661 are individually-bodied (have a `#### BC-` heading)
...
- BC-X.4.009 (ADV-P1-029) is a `#### BC-` heading in cross-cutting.md; it is
  included in cross-cutting's `total_bcs: 151` and in the **661 sum**.
  It does NOT add +1 beyond the 656.
  _(Note updated 2026-08-13 F2 spec evolution, bucket1-defects bundle, issue #663: 661 total
  after +1 BC BC-1.2.047; was 660 before this addition; prior note: 660 total after +2 BCs
...
| bc-02-issue-read.md | 108 | bc-2-issue-read.md | 108 | YES (bumped 2026-08-13; +2 BCs BC-2.2.032 + BC-2.3.039 added F2 issue #668 duedate feature; prior: bumped 2026-07-15; +12 BCs BC-2.7.001..012 added SOH-ATTACHMENTS-1 F2 DEC-179) |
| bc-03-issue-write.md | 140 | bc-3-issue-write.md | 140 | YES (bumped 2026-07-15; +14 BCs BC-3.9.001..014 added SOH-ATTACHMENTS-1 F2 DEC-179; +6 BCs BC-3.9.015..020 added adversary pass-1 round B 2026-07-15) |
...
- Group 20 (Issue Create Pre-flight Guards, SOH-DX-1 F2 2026-07-29, #639, DEC-188): H-NEW-PREFLIGHT-001..H-NEW-PREFLIGHT-006 (BC-3.8.012/013; --field and --on-behalf-of exit 64 pre-flight on platform path without --request-type; 6 scenarios covering: --field alone, --on-behalf-of alone, both combined, neither regression pin, JSM non-mis-fire, --output json envelope; overrides F51-001 coverage-non-goal per F2 gate human ruling) — +6

_Note: holdout-scenarios.md frontmatter `total_holdouts: 106` counts all holdout entries; the grep count of `^### H-` headings also returns 106. The frontmatter count (106) is authoritative. Last reconciled: 2026-07-29 (SOH-DX-1 F2 P-holdout authoring; +H-NEW-PREFLIGHT-001..006 — BC-3.8.012/013 pre-flight guards for --field and --on-behalf-of without --request-type; DEC-188, #639)._
