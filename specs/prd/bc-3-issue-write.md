...
all pre-POST helper HTTP — see Platform-Path Guard Ordering block above (steps 3–5 (pre-POST helper HTTP); step 6 (POST) is the excluded terminal case — see SSOT block for the authoritative enumeration).
