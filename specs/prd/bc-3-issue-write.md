...
**Trace**: F2 spec evolution (2026-07-09, DEC-168 ruling 1; research verdict Claim 1 REFUTED-footgun; adversary pass-5 M6b marker (since resolved — PRESERVED verdict 2026-07-09); adversary pass-32 F2 VP-577-025 human-echo-marker pin; issue #577 SOH-COMMENT-CRUD-1)
...
- **Confirm path** (Y or `--yes`): output follows BC-3.5.005 Response 200 output with `changed_fields.jsm_internal: false`; human echo appends `" (marked public)"` per the updated terminology. (Echo marker pinned by VP-577-025 second variant.)
