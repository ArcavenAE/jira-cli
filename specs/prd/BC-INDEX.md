...
last_updated: 2026-07-16  # P16 adversary fix round: BC-3.9.003 row Step-0 issue GET + projectTypeKey pin (P16-003); BC-3.9.014 row allocation S5→S3 (P16-002/R3.13); BC-3.9.015 row metadata-fetch-failure taxonomy extended 403/401/5xx (P16-005); BC-3.9.020 row retitle to match P14-010 body (INFO-7); spec v1.3.56; BC count unchanged (657); BC-INDEX v6.16
index_version: v6.16
source_pass: 3
sections:
