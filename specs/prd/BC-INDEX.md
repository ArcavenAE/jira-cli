...
last_updated: 2026-07-17  # F3 adversary pass-3 micro-round: BC-3.9.010 row updated (EC-3.9.010-5 all-404 human-mode HINT; P3-011); BC-3.9.020 row updated (EC-3.9.020-9 three-category dry-run taxonomy; P3-007); spec v1.3.82; BC count unchanged (657); holdout count 100 (unchanged); VP count 35 (unchanged); BC-INDEX v6.35. Previous: r43 micro-fix round: BC-INDEX rows updated for 6 BCs modified in v1.3.80 (GAP-R43-001): BC-2.7.007/BC-2.7.008/BC-2.7.010/BC-2.7.011/BC-3.9.015/BC-3.9.017; spec v1.3.81; BC-INDEX v6.34
index_version: v6.35
source_pass: 3
sections:
