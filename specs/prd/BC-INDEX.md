...
last_updated: 2026-07-16  # P15 adversary fix round: BC-2.7.011 row "255-byte cap"→"214-byte cap" (P15-001); BC-3.9.005 row en-dash→ASCII (P15-003); BC-3.9.017 row gate requirement added (P15-002/R3.12); holdout count 97→98 (H-NEW-ATTACHMENT-010 added); spec v1.3.55; BC count unchanged (657); BC-INDEX v6.15
index_version: v6.15
source_pass: 3
sections:
