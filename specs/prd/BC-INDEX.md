...
last_updated: 2026-07-26  # SOH-DX-1 DEC-188 v1.3.108 round-10 spec-text corrections: BC-3.8.013 error-string parenthetical removed; AC-12 renamed + help-text pin; ADR-0014 three-site enumeration; AC namespace note; assert_json_error_envelope promotion directive; spec v1.3.108; BC count unchanged (657); BC-INDEX v6.45. Previous: SOH-DX-1 DEC-188: BC-3.8.012/013 superseded (warn+proceed → pre-flight exit-64); spec v1.3.107; BC count unchanged (657).
index_version: v6.45
source_pass: 3
sections:
