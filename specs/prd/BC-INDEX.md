...
last_updated: 2026-07-24  # BC-3.9.006 Trace citation refresh post FIX-F5-006/007 merges (F5-R3-003): spec v1.3.101; BC count unchanged (657); BC-INDEX v6.39. Previous: FIX-F5-006 F5-R1-007 fix round: BC-3.9.006 row updated — step-2 network branch split from 5xx; transport/network → NetworkError, no retry hint; spec v1.3.100; BC count unchanged (657); BC-INDEX v6.38
index_version: v6.39
source_pass: 3
sections:
