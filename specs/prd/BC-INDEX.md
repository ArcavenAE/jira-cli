...
last_updated: 2026-07-26  # SOH-DX-1 DEC-188 v1.3.114 round-16 adversary-pass corrections: AC-3 self-contradiction resolved (REGRESSION PIN); AC-1/2/5/7 pins added; AC-14 --project PROJ + BC-3.8.016 positive assertion; AC-13/16/17/18/19 discrimination notes; Outputs/Effects file cite corrected; SSOT steps 3/4 deduped; AC-11 step3; spec v1.3.114; BC count unchanged (657); BC-INDEX v6.45. Previous: v1.3.113 round-15: AC-1 human mode; AC-10 json mode; AC-3 invocation+pin; stdout.trim predicate; AC-18 non-normative; AC-8 endpoints.
index_version: v6.45
source_pass: 3
sections:
