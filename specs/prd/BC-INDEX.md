...
last_updated: 2026-07-26  # SOH-DX-1 DEC-188 v1.3.115 round-17 adversary-pass corrections: F17-01 AC-8/11 MockServer isolation (MUST NOT mount_platform_create_stubs; FIFO); F17-02 AC-1/2/3/5 OLD ASSERTIONS completion; F17-03 AC-1 (ii) corrected; F17-04 AC-1/3/8/9/11/18/19 Created-issue discriminator; LOW-1 BC-3.8.012/013 H1 title prepended; LOW-2 changelog ratification markers; spec v1.3.115; BC count unchanged (657); BC-INDEX v6.45. Previous: v1.3.114 round-16: AC-3 REGRESSION PIN; AC-1/2/5/7 pins; AC-14 --project PROJ; discrimination notes; file cite corrected; SSOT steps 3/4 deduped.
index_version: v6.45
source_pass: 3
sections:
