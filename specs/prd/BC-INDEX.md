...
last_updated: 2026-07-16  # P19 adversary fix round: BC-2.7.002 row BTreeMap-alphabetical key order (P19-001); BC-3.9.001 row --dry-run clap-requires annotation (P19-004) + 4-column vs 6-column note (P19-I1); BC-3.9.009 row key order updated (P19-001); spec v1.3.59; BC count unchanged (657); BC-INDEX v6.19
index_version: v6.19
source_pass: 3
sections:
