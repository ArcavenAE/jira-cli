...
| BC-3.9.012 | Upload error taxonomy: file-not-found exit 64; issue-key 404 exit 64; --public non-JSM exit 64; **non-interactive-no-yes trigger: local (after Step-0 issue GET + meta fetch) — P22-001**; non-interactive-no-yes exit 64; 413 exit 1 (actionable, no numeric limit); 403 exit 1; 400 exit 1 (Jira body); 401 exit 2; 5xx exit 1; network exit 1 | — (SOH-ATTACHMENTS-1 F2; P22-001) | src/cli/issue/attachments.rs (pending S3/S5) | HIGH |
