...
last_updated: 2026-07-26  # SOH-DX-1 DEC-188 v1.3.116 round-18 adversary-pass corrections: F18-001 AC-2/4/6 NORMATIVE DELETE mandates for vacuous negatives (~:2551/~:2671/~:2675/~:2799); F18-002 AC-4 third negative (combined-error string); F18-003 AC-20 NEW JSM non-mis-fire pin + namespace note AC-1..19→AC-1..20 + BC-3.8.013 Trace updated; LOW-1 preamble 001..011→002..011; spec v1.3.116; BC count unchanged (657); BC-INDEX v6.45. Previous: v1.3.115 round-17: F17-01 AC-8/11 MockServer isolation (MUST NOT mount_platform_create_stubs; FIFO); F17-02 AC-1/2/3/5 OLD ASSERTIONS completion; F17-03 AC-1 (ii) corrected; F17-04 AC-1/3/8/9/11/18/19 Created-issue discriminator; LOW-1 BC-3.8.012/013 H1 title prepended; LOW-2 changelog ratification markers.
index_version: v6.45
source_pass: 3
sections:
