...
last_updated: 2026-07-26  # SOH-DX-1 DEC-188 v1.3.113 round-15 adversary-pass corrections: AC-1 re-scoped human mode; AC-10 [mode: --output json] annotated; AC-3 invocation+exit64+removal-pin; Outputs/Effects stdout.trim().is_empty() normative; AC-18 stdin-consumed demoted non-normative; AC-8 team-endpoints enumerated; Obs-1 BC-3.3.001 H1 qualifier; Obs-2 EC-3.8.012-6 no-AC note; spec v1.3.113; BC count unchanged (657); BC-INDEX v6.45. Previous: v1.3.112 round-14: AC-1/2/7 re-specified; AC-11 discriminators; EC-9 re-scoped; mode annotations.
index_version: v6.45
source_pass: 3
sections:
