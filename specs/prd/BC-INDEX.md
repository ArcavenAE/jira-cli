...
last_updated: 2026-07-24  # P8-001/F5-R8-001 deliberate-asymmetry note: BC-3.9.006 429 no-Retry-After carve-out documented; spec v1.3.105; BC count unchanged (657); BC-INDEX v6.43. Previous: F5-R6-001 io-site count fix: BC-2.7.012 three→four io sites (flush + delayed-allocation note); F5-R6-002 INFO note (mid-stream abort sub-case); spec v1.3.104; BC count unchanged (657); BC-INDEX v6.42
index_version: v6.43
source_pass: 3
sections:
