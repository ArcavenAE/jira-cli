...
last_updated: 2026-07-24  # WAVE-576-05 F5-R12-001: BC-X.8.010 EC-X.8.010-2 + stale_healed per-command-not-per-file DOCUMENT-AS-IS note; 0 new BCs; spec v1.3.106; BC count unchanged (657); BC-INDEX v6.44. Previous: P8-001/F5-R8-001 deliberate-asymmetry note: BC-3.9.006 429 no-Retry-After carve-out documented; spec v1.3.105; BC count unchanged (657); BC-INDEX v6.43
index_version: v6.44
source_pass: 3
sections:
