...
last_updated: 2026-07-24  # F5-R6-001 io-site count fix: BC-2.7.012 three→four io sites (flush + delayed-allocation note); F5-R6-002 INFO note (mid-stream abort sub-case); spec v1.3.104; BC count unchanged (657); BC-INDEX v6.42. Previous: FIX-F5-010 Windows CI collision: BC-2.7.012 permission-denied row dest parenthetical added; P9-001 reconciliation; spec v1.3.103; BC count unchanged (657); BC-INDEX v6.41
index_version: v6.42
source_pass: 3
sections:
