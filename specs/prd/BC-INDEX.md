...
last_updated: 2026-07-18  # PRE-F4-UNICODE-DISPLAY-SANITIZATION: BC-2.7.008/BC-2.7.010/BC-2.7.011/BC-3.9.015/BC-3.9.017 rows updated — display-sanitization character set extended (Unicode bidi/separator/NEL); cross-ref rows point to BC-2.7.011 primary clause; spec v1.3.94; BC count unchanged (657); holdout count 100 (unchanged); VP count 35 (unchanged); BC-INDEX v6.37. Previous: F3 adversary pass-11 micro-round: BC-X.8.010 row updated (EC-X.8.010-1; P11-005); spec v1.3.86; BC-INDEX v6.36
index_version: v6.37
source_pass: 3
sections:
