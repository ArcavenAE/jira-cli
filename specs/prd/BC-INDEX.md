...
last_updated: 2026-07-24  # FIX-F5-010 Windows CI collision: BC-2.7.012 permission-denied row dest parenthetical added; P9-001 reconciliation; spec v1.3.103; BC count unchanged (657); BC-INDEX v6.41. Previous: F5-R5-001 research-backed amendment: BC-2.7.012 disk-write error strings amended to HYBRID shape; spec v1.3.102; BC count unchanged (657); BC-INDEX v6.40
index_version: v6.41
source_pass: 3
sections:
