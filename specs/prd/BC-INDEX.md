...
sections:
  ...
  - bc-3-issue-write.md (140 BCs cumulative; 111 individually-bodied)
...
### 2.6 API Layer (5 BCs: BC-2.6.047..051)
...
### 3.8 JSM Request Create + Platform-Path Inverse Warnings + Auth-Conditional 401 Hints (17 BCs: BC-3.8.001..017) [Added 2026-05-18 issue #288; BC-3.8.010 added F1d pass-01; BC-3.8.011 added F1d pass-01; BC-3.8.012..013 added 2026-05-19 issue #383 F2; BC-3.8.014..015 added 2026-05-19 issue #384 F2; BC-3.8.016..017 added 2026-05-20 issue #385 F2; BC-3.8.002/010/011 modified 2026-05-20 issue #385 F2]
...
| BC-3.9.006 | temporaryAttachmentId ~1h TTL; second-step failure → generic retry hint "Temporary attachment IDs may have expired. Try the upload again."; no pattern-matching Cloud error strings (P2-2); no ID caching or reuse across invocations; second-step 4xx (excl. 401/403) → exit 64; 401 → exit 2; 403 → exit 1 | — (SOH-ATTACHMENTS-1 F2) | src/api/jsm/attachments.rs (pending S5) | MEDIUM-HIGH |
...
## Section 6: Config & Cache (bc-6-config-cache.md) — 43 BCs cumulative; 33 individually-bodied
...
### X.13 CI Guards (6 BCs: BC-X.13.001..006) [BC-X.13.001..003 added 2026-06-19 DEAD-CITATION-CI F2; BC-X.13.004..006 added 2026-07-05 CITATION-GUARDS Story B S-BC-CITATION-GUARD-1 issue #102]
