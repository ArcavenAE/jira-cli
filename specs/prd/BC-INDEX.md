...
last_updated: 2026-07-18  # F3 adversary pass-11 micro-round: BC-X.8.010 row updated (EC-X.8.010-1 service-desk-list no-match None-path exit 64; P11-005); spec v1.3.86; BC count unchanged (657); holdout count 100 (unchanged); VP count 35 (unchanged); BC-INDEX v6.36. Previous: F3 adversary pass-3 micro-round: BC-3.9.010 row updated (EC-3.9.010-5 all-404 human-mode HINT; P3-011); BC-3.9.020 row updated (EC-3.9.020-9 three-category dry-run taxonomy; P3-007); spec v1.3.82; BC-INDEX v6.35
index_version: v6.36
source_pass: 3
sections:
