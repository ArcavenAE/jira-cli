...
| BC-1.2.018 | Global `--profile` propagates to all auth subcommands via subcmd.profile.or(cli.profile) | BC-030 (R1) | tests/auth_profiles.rs:~188-231 | HIGH |
