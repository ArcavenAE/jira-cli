...
| [risk-register.md](risk-register.md) | 26 architectural risks (12 R1-NEW + 14 broad-pass) by severity |
...
|--------|-----------|-----|----------|-----|-----------|
| Multi-profile fields | BC-6.3.001 | NFR-R-D | CRITICAL | ADR-0007 | Add `Config::field_id()` accessor; update 12+ sites |
