...
## Trigger (jira-cli SOH-COMMENT-CRUD-1, F4 wave-A — PG-F4-3 / D-172 D1)
...
jira-cli SOH-COMMENT-CRUD-1 session review 2026-07-15 (IP-577-11). Codified in `.factory/cycles/cycle-001/lessons.md` as PG-F4-3. Ratified as D-172 D1 in jira-cli STATE.md.
