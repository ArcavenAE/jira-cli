...
Run: `./target/debug/jr --verbose issue list --project FOO --team "Platform"`
...
Run: `./target/debug/jr issue create --project FOO --type Task --summary "Team test ticket" --team "Platform" --output json`
