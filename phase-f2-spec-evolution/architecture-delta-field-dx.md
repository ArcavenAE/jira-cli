...
implementation module exists yet to classify a kill-rate tier against. The D-310 governance
flag (renumbered from the initially-proposed D-307, which was already cycle-001's;
BC-3.8.012's reversal of a deliberate breaking change, D-188) is the product-owner's/
