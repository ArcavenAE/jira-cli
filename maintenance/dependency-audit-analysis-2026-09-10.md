...
| 3c | 3× `license-not-encountered` warnings, 1× `unmatched-skip` (`cpufeatures`, D-185) | LOW | No | No action needed; pre-authorized/unused-allowance hygiene items only. |
