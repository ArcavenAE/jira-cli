...
4. **Defer, don't block:** fold the orphaned `thiserror 1.0.69` lockfile entry
   ...
   verify the `cpufeatures` skip is still needed (per D-185) before removing
   it.
